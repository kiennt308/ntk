...
### Câu 1
**Câu hỏi:** `npm ci` khác `npm install` ở **ba** điểm cốt lõi nào, và vì sao trong môi trường CI/CD Pipeline chỉ có `npm ci` là câu lệnh cài đặt phụ thuộc hợp lệ duy nhất?
