...
<code>ResourceQuota</code> quản lý tổng trần tài nguyên ở cấp Namespace; <code>LimitRange</code> quản lý ngưỡng min/max và giá trị mặc định ở cấp Container/Pod.
</div>
</details>
...
Kubernetes API Server từ chối khởi tạo Pod và trả về lỗi <code>is forbidden: failed quota: ... must specify cpu for: ...</code>.
</div>
</details>
...
Tự động tiêm giá trị <code>requests</code> mặc định cho bất kỳ container nào không tự khai báo trong tệp YAML.
</div>
</details>
...
Tự động tiêm giá trị <code>limits</code> mặc định cho bất kỳ container nào không tự khai báo trong tệp YAML.
</div>
</details>
...
Triển khai một <code>LimitRange</code> song song với <code>ResourceQuota</code> trong cùng Namespace để tự động tiêm thông số tài nguyên mặc định.
</div>
</details>
...
<code>kubectl describe quota -n <namespace></code>.
</div>
</details>
...
Vì chiến lược RollingUpdate mặc định tạo thêm Pod mới (<code>maxSurge</code>) làm tổng số Pod tạm thời vượt quá trần <code>pods</code> trong Quota.
</div>
</details>
...
Lớp dịch vụ <code>Guaranteed</code>.
</div>
</details>
...
API Server từ chối tạo Pod và trả về lỗi <code>requests.memory is higher than limitrange max</code>.
</div>
</details>
