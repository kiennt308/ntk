...
<summary class="qa-summary">
  <div class="qa-summary-left">
    ...
    <span>Tính năng Kubernetes Audit Logging đóng vai trò gì trong công tác bảo mật cụm?</span>
  </div>
...
<div class="qa-answer">
  ...
  Ghi lại 100% các hành vi tương tác với API Server để phục vụ quá trình **điều tra sự cố bảo mật (Security Incident Response)**.
</div>
</details>
...
<summary class="qa-summary">
  <div class="qa-summary-left">
    ...
    <span>Hãy kể tên 4 cấp độ ghi kiểm toán (Audit Levels) trong tệp chính sách `audit-policy.yaml`?</span>
  </div>
  <span class="qa-chevron">
    <svg width="18" height="18" fill="none" stroke="currentColor" stroke-width="2.5" viewBox="0 0 24 24"><polyline points="6 9 12 15 18 9"></polyline></svg>
  </span>
...
<div class="qa-answer">
  ...
  4 cấp độ: **`None`**, **`Metadata`**, **`Request`**, và **`RequestResponse`**.
</div>
</details>
...
<summary class="qa-summary">
  <div class="qa-summary-left">
    ...
    <span>Sự khác nhau giữa 2 cấp độ Audit Level `Metadata` và `RequestResponse` là gì?</span>
  </div>
  <span class="qa-chevron">
    <svg width="18" height="18" fill="none" stroke="currentColor" stroke-width="2.5" viewBox="0 0 24 24"><polyline points="6 9 12 15 18 9"></polyline></svg>
  </span>
...
<div class="qa-answer">
  ...
  `Metadata` **chỉ ghi lại thông tin định danh** (User, Verb, IP, Resource), còn `RequestResponse` **ghi đầy đủ cả payload nội dung request và response body**.
</div>
</details>
...
<summary class="qa-summary">
  <div class="qa-summary-left">
    ...
    <span>Hai cờ câu lệnh bắt buộc phải thêm vào Static Pod `kube-apiserver` để kích hoạt Audit Logging là gì?</span>
  </div>
  <span class="qa-chevron">
    <svg width="18" height="18" fill="none" stroke="currentColor" stroke-width="2.5" viewBox="0 0 24 24"><polyline points="6 9 12 15 18 9"></polyline></svg>
  </span>
...
<div class="qa-answer">
  ...
  Cờ `--audit-policy-file=/etc/kubernetes/audit/policy.yaml` và `--audit-log-path=/var/log/kubernetes/audit/audit.log`.
</div>
</details>
...
<summary class="qa-summary">
  <div class="qa-summary-left">
    ...
    <span>Cú pháp `apiVersion` chuẩn của tệp chính sách `audit-policy.yaml` là gì?</span>
  </div>
  <span class="qa-chevron">
    <svg width="18" height="18" fill="none" stroke="currentColor" stroke-width="2.5" viewBox="0 0 24 24"><polyline points="6 9 12 15 18 9"></polyline></svg>
  </span>
...
<div class="qa-answer">
  ...
  `apiVersion: audit.k8s.io/v1` (với `kind: Policy`).
</div>
</details>
...
<summary class="qa-summary">
  <div class="qa-summary-left">
    ...
    <span>Tại sao trong tệp `audit-policy.yaml`, các sự kiện `get`, `list`, `watch` trên `configmaps` trong `kube-system` nên được đặt ở mức `level: None`?</span>
  </div>
  <span class="qa-chevron">
    <svg width="18" height="18" fill="none" stroke="currentColor" stroke-width="2.5" viewBox="0 0 24 24"><polyline points="6 9 12 15 18 9"></polyline></svg>
  </span>
...
<div class="qa-answer">
  ...
  Để **bỏ qua các sự kiện rác có tần suất cực cao**, tránh làm phình to tràn ổ đĩa đệm.
</div>
</details>
...
<summary class="qa-summary">
  <div class="qa-summary-left">
    ...
    <span>Ba cờ xoay vòng log tự động trên `kube-apiserver` giúp giới hạn dung lượng lưu trữ tệp nhật ký Audit là gì?</span>
  </div>
  <span class="qa-chevron">
    <svg width="18" height="18" fill="none" stroke="currentColor" stroke-width="2.5" viewBox="0 0 24 24"><polyline points="6 9 12 15 18 9"></polyline></svg>
  </span>
...
<div class="qa-answer">
  ...
  `--audit-log-maxage` (số ngày tối đa), `--audit-log-maxbackup` (số file backup tối đa), và `--audit-log-maxsize` (dung lượng MB mỗi file).
</div>
</details>
...
<summary class="qa-summary">
  <div class="qa-summary-left">
    ...
    <span>Đường dẫn thư mục mặc định lưu trữ tệp nhật ký kiểm toán `audit.log` trên Host Node Control Plane là gì?</span>
  </div>
  <span class="qa-chevron">
    <svg width="18" height="18" fill="none" stroke="currentColor" stroke-width="2.5" viewBox="0 0 24 24"><polyline points="6 9 12 15 18 9"></polyline></svg>
  </span>
...
<div class="qa-answer">
  ...
  Đường dẫn `/var/log/kubernetes/audit/audit.log`.
</div>
</details>
...
<summary class="qa-summary">
  <div class="qa-summary-left">
    ...
    <span>Tại sao thư mục chứa tệp nhật ký Audit phải được mount vào container `kube-apiserver` với cờ `readOnly: false`?</span>
  </div>
  <span class="qa-chevron">
    <svg width="18" height="18" fill="none" stroke="currentColor" stroke-width="2.5" viewBox="0 0 24 24"><polyline points="6 9 12 15 18 9"></polyline></svg>
  </span>
...
<div class="qa-answer">
  ...
  Để tiến trình `kube-apiserver` có **quền ghi tệp nhật ký** ra ổ đĩa Host.
</div>
</details>
...
<summary class="qa-summary">
  <div class="qa-summary-left">
    ...
    <span>Công cụ CLI nào được sử dụng phổ biến nhất để lọc và trích xuất dữ liệu JSON từ tệp `audit.log`?</span>
  </div>
  <span class="qa-chevron">
    <svg width="18" height="18" fill="none" stroke="currentColor" stroke-width="2.5" viewBox="0 0 24 24"><polyline points="6 9 12 15 18 9"></polyline></svg>
  </span>
...
<summary class="qa-summary">
  <div class="qa-summary-left">
    ...
    <span>Mã phản hồi HTTP nào trong tệp `audit.log` đại diện cho một request vi phạm bị RBAC chối bỏ quyền truy cập?</span>
  </div>
  <span class="qa-chevron">
    <svg width="18" height="18" fill="none" stroke="currentColor" stroke-width="2.5" viewBox="0 0 24 24"><polyline points="6 9 12 15 18 9"></polyline></svg>
  </span>
...
<summary class="qa-summary">
  <div class="qa-summary-left">
    ...
    <span>Cú pháp YAML chuẩn của tệp chính sách `audit-policy.yaml` ghi `RequestResponse` cho `secrets` CKS là gì?</span>
  </div>
  <span class="qa-chevron">
    <svg width="18" height="18" fill="none" stroke="currentColor" stroke-width="2.5" viewBox="0 0 24 24"><polyline points="6 9 12 15 18 9"></polyline></svg>
  </span>
...
<summary class="qa-summary">
  <div class="qa-summary-left">
    <span class="qa-num-badge">Q01</span>
    <span>Tính năng Kubernetes Audit Logging đóng vai trò gì trong công tác điều tra truy vết sự cố bảo mật (Security Incident Response)?</span>
  </div>
  <span class="qa-chevron">
    <svg width="18" height="18" fill="none" stroke="currentColor" stroke-width="2.5" viewBox="0 0 24 24"><polyline points="6 9 12 15 18 9"></polyline></svg>
  </span>
...
<div class="qa-answer">
  ...
  Giúp ghi lại 100% các hành vi tương tác với API Server (ai đã làm gì, lúc nào, tác động tới tài nguyên nào, từ IP nào, thành công hay thất bại). Nếu không có Audit Log, quản trị viên hoàn toàn không thể tái dựng lại kịch bản tấn công khi hệ thống bị xâm nhập.
...
<summary class="qa-summary">
  <div class="qa-summary-left">
    <span class="qa-num-badge">Q01</span>
    <span>— Tạo tệp chính sách Audit Policy `/tmp/audit-policy.yaml</span>
  </div>
  <span class="qa-chevron">
    <svg width="18" height="18" fill="none" stroke="currentColor" stroke-width="2.5" viewBox="0 0 24 24"><polyline points="6 9 12 15 18 9"></polyline></svg>
  </span>
...
<summary class="qa-summary">
  <div class="qa-summary-left">
    <span class="qa-num-badge">Q02</span>
    <span>— Cấu hình cờ `kube-apiserver</span>
  </div>
  <span class="qa-chevron">
    <svg width="18" height="18" fill="none" stroke="currentColor" stroke-width="2.5" viewBox="0 0 24 24"><polyline points="6 9 12 15 18 9"></polyline></svg>
  </span>
...
<summary class="qa-summary">
  <div class="qa-summary-left">
    <span class="qa-num-badge">Q03</span>
    <span>— Tìm User xóa Deployment từ tệp audit log</span>
  </div>
  <span class="qa-chevron">
    <svg width="18" height="18" fill="none" stroke="currentColor" stroke-width="2.5" viewBox="0 0 24 24"><polyline points="6 9 12 15 18 9"></polyline></svg>
  </span>
...
<summary class="qa-summary">
  <div class="qa-summary-left">
    <span class="qa-num-badge">Q04</span>
    <span>— Trích xuất request đọc Secret bị chối bỏ 403</span>
  </div>
  <span class="qa-chevron">
    <svg width="18" height="18" fill="none" stroke="currentColor" stroke-width="2.5" viewBox="0 0 24 24"><polyline points="6 9 12 15 18 9"></polyline></svg>
  </span>
