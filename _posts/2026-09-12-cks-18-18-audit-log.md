...
<b style="color: var(--accent-primary);">Tiêu chí chấm:</b>
  <div style="margin: 0.35rem 0; padding-left: 1rem; border-left: 2px solid var(--accent-primary);">• 0đ: Không biết vai trò của Audit Logging.</div>
  <div style="margin: 0.35rem 0; padding-left: 1rem; border-left: 2px solid var(--accent-primary);">• 1đ: Nêu được ghi log tương tác nhưng chưa giải thích vai trò điều tra sự cố Incident Response.</div>
  <div style="margin: 0.35rem 0; padding-left: 1rem; border-left: 2px solid var(--accent-primary);">• 3đ: Phân tích thấu đáo vai trò truy vết sự cố của Audit Logging trong cụm Kubernetes.</div>

<b style="color: var(--accent-primary);">Câu hỏi đào sâu:</b> (Đường dẫn tệp nhật ký kiểm toán mặc định trên Node Control Plane là gì? — Đường dẫn <code>/var/log/kubernetes/audit/audit.log</code>).
</div>
</details>
