...
<summary class="qa-summary">
  <div class="qa-summary-left">
    ...
    <span>Chiến thuật 3 lượt làm bài 120 phút trong kỳ thi CKS được phân bổ như thế nào để tối ưu hóa khả năng đỗ?</span>
  </div>
...
<div class="qa-answer">
  ...
  <div style="margin: 0.35rem 0; padding-left: 1rem; border-left: 2px solid var(--accent-primary);">• <b style="color: var(--accent-primary);">Lượt 1 (0–50 phút)</b>: Làm các câu dễ/quen thuộc (NetworkPolicy, RBAC, Secret, Kubesec) -> Gom ~50 điểm chắc chắn.</div>
  <div style="margin: 0.35rem 0; padding-left: 1rem; border-left: 2px solid var(--accent-primary);">• <b style="color: var(--accent-primary);">Lượt 2 (50–95 phút)</b>: Làm các câu trung bình (Allowed Registries, Audit Policy, Falco) -> Gom thêm ~30 điểm.</div>
  <div style="margin: 0.35rem 0; padding-left: 1rem; border-left: 2px solid var(--accent-primary);">• <b style="color: var(--accent-primary);">Lượt 3 (95–120 phút)</b>: Xử lý các câu nâng cao (ImagePolicyWebhook, AppArmor) và rà soát lại toàn bộ 16 câu.</div>
  ...
  <div style="margin: 0.25rem 0; padding-left: 1rem; border-left: 2px solid var(--accent-primary);">• 1đ: Nêu được làm câu dễ trước nhưng chưa rõ phân bổ mốc thời gian 3 lượt.</div>
  <div style="margin: 0.25rem 0; padding-left: 1rem; border-left: 2px solid var(--accent-primary);">• 3đ: Phân tích thấu đáo chiến thuật 3 lượt làm bài CKS 120 phút.</div>
  <div style="margin-top: 0.75rem; padding: 0.5rem 0.75rem; background: rgba(var(--accent-primary-rgb, 59, 130, 246), 0.08); border-radius: 4px;"><b style="color: var(--accent-primary);">Câu hỏi mở rộng / Đào sâu:</b> (Nếu dính một câu quá khó ở ngay Lượt 1 thì xử lý ra sao? — Lập tức bỏ qua, gắn nhãn đánh dấu để quay lại làm ở Lượt 3, không sa lầy quá 8 phút).
...
<summary class="qa-summary">
  <div class="qa-summary-left">
    ...
    <span>Thao tác quan trọng nhất BẮT BUỘC phải thực hiện ở đầu MỌI CÂU HỎI trong bài thi CKS là gì?</span>
  </div>
  <span class="qa-chevron">
    <svg width="18" height="18" fill="none" stroke="currentColor" stroke-width="2.5" viewBox="0 0 24 24"><polyline points="6 9 12 15 18 9"></polyline></svg>
  </span>
...
<div class="qa-answer">
  ...
  <div style="margin: 0.35rem 0; padding-left: 1rem; border-left: 2px solid var(--accent-primary);">Gõ lệnh chuyển đúng context cụm Kubernetes: <code>kubectl config use-context <cluster-context-name></code>. Vì bài thi CKS sử dụng từ 4–6 cụm khác nhau, làm bài sai context sẽ bị tính 0 điểm dù thao tác hoàn toàn đúng.</div>
  <div style="margin-top: 0.75rem;"><b style="color: var(--accent-primary);">Tiêu chí chấm điểm &amp; Phân tầng năng lực:</b></div>
  <div style="margin: 0.25rem 0; padding-left: 1rem; border-left: 2px solid var(--accent-primary);">• 0đ: Không biết việc chuyển context.</div>
  <div style="margin: 0.25rem 0; padding-left: 1rem; border-left: 2px solid var(--accent-primary);">• 1đ: Nêu được check context nhưng chưa rõ lệnh <code>kubectl config use-context</code>.</div>
  <div style="margin: 0.25rem 0; padding-left: 1rem; border-left: 2px solid var(--accent-primary);">• 3đ: Phân tích chuẩn xác tầm quan trọng sống còn của việc chuyển context ở đầu mỗi câu thi.</div>
  <div style="margin-top: 0.75rem; padding: 0.5rem 0.75rem; background: rgba(var(--accent-primary-rgb, 59, 130, 246), 0.08); border-radius: 4px;"><b style="color: var(--accent-primary);">Câu hỏi mở rộng / Đào sâu:</b> (Lệnh CLI nào dùng để xem context hiện tại đang đứng? — Lệnh <code>kubectl config current-context</code>).
...
<summary class="qa-summary">
  <div class="qa-summary-left">
    ...
    <span>Phương pháp sao lưu và khôi phục khẩn cấp tệp <code>kube-apiserver.yaml</code> khi gõ sai syntax làm sập Control Plane trong lúc thi?</span>
  </div>
  <span class="qa-chevron">
    <svg width="18" height="18" fill="none" stroke="currentColor" stroke-width="2.5" viewBox="0 0 24 24"><polyline points="6 9 12 15 18 9"></polyline></svg>
  </span>
...
<div class="qa-answer">
  ...
  <div style="margin: 0.35rem 0; padding-left: 1rem; border-left: 2px solid var(--accent-primary);">• <b style="color: var(--accent-primary);">Khôi phục khẩn cấp</b>: <code>sudo mv /tmp/apiserver.bak /etc/kubernetes/manifests/kube-apiserver.yaml</code>. Kubelet sẽ tự động khởi chạy lại apiserver trong 60 giây.</div>
  <div style="margin-top: 0.75rem;"><b style="color: var(--accent-primary);">Tiêu chí chấm điểm &amp; Phân tầng năng lực:</b></div>
  <div style="margin: 0.25rem 0; padding-left: 1rem; border-left: 2px solid var(--accent-primary);">• 0đ: Không biết cách backup khôi phục apiserver.</div>
  <div style="margin: 0.25rem 0; padding-left: 1rem; border-left: 2px solid var(--accent-primary);">• 1đ: Nêu được copy file nhưng chưa rõ vị trí file Static Pod <code>/etc/kubernetes/manifests/</code>.</div>
  <div style="margin: 0.25rem 0; padding-left: 1rem; border-left: 2px solid var(--accent-primary);">• 3đ: Trình bày chính xác quy trình sao lưu và khôi phục khẩn cấp Static Pod <code>kube-apiserver.yaml</code>.</div>
  <div style="margin-top: 0.75rem; padding: 0.5rem 0.75rem; background: rgba(var(--accent-primary-rgb, 59, 130, 246), 0.08); border-radius: 4px;"><b style="color: var(--accent-primary);">Câu hỏi mở rộng / Đào sâu:</b> (Lệnh nào kiểm tra xem apiserver đã khởi chạy lại thành công chưa? — Lệnh <code>crictl ps | grep kube-apiserver</code> hoặc <code>kubectl get pods -n kube-system</code>).
...
<summary class="qa-summary">
  <div class="qa-summary-left">
    ...
    <span>Hai alias CLI quan trọng nhất nên thiết lập ngay khi bắt đầu bài thi CKS để tăng 300% tốc độ gõ lệnh là gì?</span>
  </div>
  <span class="qa-chevron">
    <svg width="18" height="18" fill="none" stroke="currentColor" stroke-width="2.5" viewBox="0 0 24 24"><polyline points="6 9 12 15 18 9"></polyline></svg>
  </span>
...
<div class="qa-answer">
  ...
  <div style="margin: 0.35rem 0; padding-left: 1rem; border-left: 2px solid var(--accent-primary);">• <code>alias k=kubectl</code> (Rút gọn lệnh kubectl).</div>
  <div style="margin: 0.35rem 0; padding-left: 1rem; border-left: 2px solid var(--accent-primary);">• <code>export do="--dry-run=client -o yaml"</code> (Rút gọn cờ sinh khung manifest YAML).</div>
  <div style="margin: 0.35rem 0; padding-left: 1rem; border-left: 2px solid var(--accent-primary);">• Khi dùng: <code>k run nginx --image=nginx $do > /tmp/pod.yaml</code>.</div>
  <div style="margin-top: 0.75rem;"><b style="color: var(--accent-primary);">Tiêu chí chấm điểm &amp; Phân tầng năng lực:</b></div>
  <div style="margin: 0.25rem 0; padding-left: 1rem; border-left: 2px solid var(--accent-primary);">• 0đ: Không biết sử dụng alias CLI.</div>
  <div style="margin: 0.25rem 0; padding-left: 1rem; border-left: 2px solid var(--accent-primary);">• 1đ: Nêu được alias k=kubectl nhưng thiếu export do dry-run.</div>
  <div style="margin: 0.25rem 0; padding-left: 1rem; border-left: 2px solid var(--accent-primary);">• 3đ: Trình bày chuẩn xác 2 alias CLI tăng tốc độ gõ lệnh CKS.</div>
  <div style="margin-top: 0.75rem; padding: 0.5rem 0.75rem; background: rgba(var(--accent-primary-rgb, 59, 130, 246), 0.08); border-radius: 4px;"><b style="color: var(--accent-primary);">Câu hỏi mở rộng / Đào sâu:</b> (Lệnh nào tự động bật tính năng autocomplete tab cho kubectl? — Lệnh <code>source <(kubectl completion bash)</code> và <code>complete -o default -F __start_kubectl k</code>).
...
<summary class="qa-summary">
  <div class="qa-summary-left">
    ...
    <span>Trang web duy nhất được phép truy cập để tra cứu tài liệu trong bài thi CKS thực hành do CNCF quy định là gì?</span>
  </div>
  <span class="qa-chevron">
    <svg width="18" height="18" fill="none" stroke="currentColor" stroke-width="2.5" viewBox="0 0 24 24"><polyline points="6 9 12 15 18 9"></polyline></svg>
  </span>
...
<div class="qa-answer">
  ...
  <div style="margin: 0.35rem 0; padding-left: 1rem; border-left: 2px solid var(--accent-primary);">Trang chính thức <b style="color: var(--accent-primary);"><code>https://kubernetes.io/docs/</code></b> (và sub-domain <code>github.com/kubernetes/</code>, <code>falco.org/docs/</code> đối với câu hỏi Falco). Không được mở bất kỳ trang blog hay công cụ tìm kiếm Google nào khác.</div>
  <div style="margin-top: 0.75rem;"><b style="color: var(--accent-primary);">Tiêu chí chấm điểm &amp; Phân tầng năng lực:</b></div>
  <div style="margin: 0.25rem 0; padding-left: 1rem; border-left: 2px solid var(--accent-primary);">• 0đ: Nhầm lẫn các trang web được phép mở.</div>
  <div style="margin: 0.25rem 0; padding-left: 1rem; border-left: 2px solid var(--accent-primary);">• 1đ: Nêu được kubernetes.io nhưng thiếu falco.org/docs.</div>
  <div style="margin: 0.25rem 0; padding-left: 1rem; border-left: 2px solid var(--accent-primary);">• 3đ: Trình bày chuẩn xác quy định trang web được phép mở trong bài thi CKS.</div>
  <div style="margin-top: 0.75rem; padding: 0.5rem 0.75rem; background: rgba(var(--accent-primary-rgb, 59, 130, 246), 0.08); border-radius: 4px;"><b style="color: var(--accent-primary);">Câu hỏi mở rộng / Đào sâu:</b> (Thí sinh có được sử dụng các dấu trang (bookmarks) chuẩn bị sẵn từ trước không? — ĐƯỢC! Được mở các bookmark trỏ trực tiếp tới các trang trong <code>kubernetes.io/docs/</code>).
...
<summary class="qa-summary">
  <div class="qa-summary-left">
    ...
    <span>Tại sao việc lưu kết quả bài làm ra đúng đường dẫn tệp output đề bài yêu cầu lại có tính chất sống còn?</span>
  </div>
  <span class="qa-chevron">
    <svg width="18" height="18" fill="none" stroke="currentColor" stroke-width="2.5" viewBox="0 0 24 24"><polyline points="6 9 12 15 18 9"></polyline></svg>
  </span>
...
<div class="qa-answer">
  ...
  <div style="margin: 0.35rem 0; padding-left: 1rem; border-left: 2px solid var(--accent-primary);">Hệ thống chấm điểm tự động của CNCF <b style="color: var(--accent-primary);">chỉ kiểm tra sự tồn tại và nội dung tệp tại ĐÚNG đường dẫn chỉ định trong đề bài</b> (như <code>/tmp/res.json</code>). Nếu làm đúng 100% nhưng lưu ra nhầm đường dẫn (như <code>/root/res.json</code>), hệ thống sẽ tính 0 điểm câu đó.</div>
  <div style="margin-top: 0.75rem;"><b style="color: var(--accent-primary);">Tiêu chí chấm điểm &amp; Phân tầng năng lực:</b></div>
  <div style="margin: 0.25rem 0; padding-left: 1rem; border-left: 2px solid var(--accent-primary);">• 0đ: Không biết bẫy đường dẫn file output.</div>
  <div style="margin: 0.25rem 0; padding-left: 1rem; border-left: 2px solid var(--accent-primary);">• 1đ: Nêu được sai file bị mất điểm nhưng chưa rõ hệ thống chấm điểm tự động.</div>
  <div style="margin: 0.25rem 0; padding-left: 1rem; border-left: 2px solid var(--accent-primary);">• 3đ: Phân tích thấu đáo nguyên lý chấm điểm tự động và bẫy đường dẫn tệp output CKS.</div>
  <div style="margin-top: 0.75rem; padding: 0.5rem 0.75rem; background: rgba(var(--accent-primary-rgb, 59, 130, 246), 0.08); border-radius: 4px;"><b style="color: var(--accent-primary);">Câu hỏi mở rộng / Đào sâu:</b> (Lệnh CLI nào dùng để kiểm tra lại sự tồn tại và nội dung tệp output trước khi chuyển câu? — Lệnh <code>cat /path/to/output-file</code> hoặc <code>ls -la /path/to/output-file</code>).
...
<summary class="qa-summary">
  <div class="qa-summary-left">
    ...
    <span>Ba câu hỏi thuộc miền <code>Supply Chain Security</code> (20%) thường xuất hiện chắc chắn trong bài thi CKS là gì?</span>
  </div>
  <span class="qa-chevron">
    <svg width="18" height="18" fill="none" stroke="currentColor" stroke-width="2.5" viewBox="0 0 24 24"><polyline points="6 9 12 15 18 9"></polyline></svg>
  </span>
...
<div class="qa-answer">
  ...
  <div style="margin: 0.35rem 0; padding-left: 1rem; border-left: 2px solid var(--accent-primary);">• <b style="color: var(--accent-primary);">Kyverno / OPA Allowed Registries</b>: Biên soạn ClusterPolicy chỉ cho phép kéo ảnh từ <code>harbor.internal/*</code>.</div>
  <div style="margin: 0.35rem 0; padding-left: 1rem; border-left: 2px solid var(--accent-primary);">• <b style="color: var(--accent-primary);">Disallow Latest Tag & Digest Pinning</b>: Cấm tag <code>:latest</code> và ghim Image Digest <code>@sha256:...</code>.</div>
  <div style="margin: 0.35rem 0; padding-left: 1rem; border-left: 2px solid var(--accent-primary);">• <b style="color: var(--accent-primary);">Kubesec / Trivy Static Analysis</b>: Quét manifest bằng <code>kubesec scan</code> và sửa Pod spec đạt điểm dương.</div>
  <div style="margin-top: 0.75rem;"><b style="color: var(--accent-primary);">Tiêu chí chấm điểm &amp; Phân tầng năng lực:</b></div>
  <div style="margin: 0.25rem 0; padding-left: 1rem; border-left: 2px solid var(--accent-primary);">• 0đ: Không nêu được 3 dạng bài Supply Chain Security.</div>
  <div style="margin: 0.25rem 0; padding-left: 1rem; border-left: 2px solid var(--accent-primary);">• 1đ: Nêu được 1 dạng bài.</div>
  <div style="margin: 0.25rem 0; padding-left: 1rem; border-left: 2px solid var(--accent-primary);">• 3đ: Kể tên chuẩn xác 3 dạng bài chắc chắn xuất hiện trong miền Supply Chain Security CKS.</div>
  <div style="margin-top: 0.75rem; padding: 0.5rem 0.75rem; background: rgba(var(--accent-primary-rgb, 59, 130, 246), 0.08); border-radius: 4px;"><b style="color: var(--accent-primary);">Câu hỏi mở rộng / Đào sâu:</b> (Mức điểm Kubesec âm thể hiện điều gì trong Pod manifest? — Thể hiện manifest dính các cờ nguy hiểm như <code>privileged: true</code> hoặc thiếu SecurityContext thắt chặt).
...
<summary class="qa-summary">
  <div class="qa-summary-left">
    ...
    <span>Hai câu hỏi thuộc miền <code>Monitoring, Logging and Runtime Security</code> (20%) chắc chắn xuất hiện trong bài thi CKS là gì?</span>
  </div>
  <span class="qa-chevron">
    <svg width="18" height="18" fill="none" stroke="currentColor" stroke-width="2.5" viewBox="0 0 24 24"><polyline points="6 9 12 15 18 9"></polyline></svg>
  </span>
...
<div class="qa-answer">
  ...
  <div style="margin: 0.35rem 0; padding-left: 1rem; border-left: 2px solid var(--accent-primary);">• <b style="color: var(--accent-primary);">Audit Logging</b>: Biên soạn tệp <code>audit-policy.yaml</code> (mức <code>RequestResponse</code> cho <code>secrets</code>) và thêm cờ <code>--audit-policy-file</code> trên <code>kube-apiserver</code>.</div>
  <div style="margin: 0.35rem 0; padding-left: 1rem; border-left: 2px solid var(--accent-primary);">• <b style="color: var(--accent-primary);">Falco Custom Rules</b>: Biên soạn quy tắc Falco đủ 5 thành tố (<code>rule</code>, <code>desc</code>, <code>condition</code>, <code>output</code>, <code>priority</code>) bắt hành vi mở shell/ghi <code>/bin</code>.</div>
  <div style="margin-top: 0.75rem;"><b style="color: var(--accent-primary);">Tiêu chí chấm điểm &amp; Phân tầng năng lực:</b></div>
  <div style="margin: 0.25rem 0; padding-left: 1rem; border-left: 2px solid var(--accent-primary);">• 0đ: Không nêu được 2 dạng bài Monitoring & Runtime.</div>
  <div style="margin: 0.25rem 0; padding-left: 1rem; border-left: 2px solid var(--accent-primary);">• 1đ: Nêu được Audit Log nhưng thiếu Falco Rules.</div>
  <div style="margin: 0.25rem 0; padding-left: 1rem; border-left: 2px solid var(--accent-primary);">• 3đ: Kể tên chuẩn xác 2 dạng bài chắc chắn xuất hiện trong miền Monitoring & Runtime CKS.</div>
  <div style="margin-top: 0.75rem; padding: 0.5rem 0.75rem; background: rgba(var(--accent-primary-rgb, 59, 130, 246), 0.08); border-radius: 4px;"><b style="color: var(--accent-primary);">Câu hỏi mở rộng / Đào sâu:</b> (File nhật ký hệ thống mặc định chứa cảnh báo Falco là gì? — File <b style="color: var(--accent-primary);">/var/log/syslog</b>).
...
<summary class="qa-summary">
  <div class="qa-summary-left">
    ...
    <span>Kỹ năng xử lý tâm lý khi dính 1 câu hỏi quá dài hoặc làm hỏng cụm sau 10 phút chưa tìm ra nguyên nhân?</span>
  </div>
  <span class="qa-chevron">
    <svg width="18" height="18" fill="none" stroke="currentColor" stroke-width="2.5" viewBox="0 0 24 24"><polyline points="6 9 12 15 18 9"></polyline></svg>
  </span>
...
<div class="qa-answer">
  ...
  <div style="margin: 0.35rem 0; padding-left: 1rem; border-left: 2px solid var(--accent-primary);">Bình tĩnh thực hiện 3 bước:</div>
  <div style="margin: 0.35rem 0; padding-left: 1rem; border-left: 2px solid var(--accent-primary);">• Khôi phục lại cụm về trạng thái ban đầu bằng file backup.</div>
  <div style="margin: 0.35rem 0; padding-left: 1rem; border-left: 2px solid var(--accent-primary);">• Gắn nhãn ghi chú câu đó vào tờ nháp để quay lại làm ở Lượt 3.</div>
  <div style="margin: 0.35rem 0; padding-left: 1rem; border-left: 2px solid var(--accent-primary);">• Lập tức chuyển sang câu tiếp theo để bảo vệ quỹ thời gian cho các câu còn lại.</div>
  <div style="margin-top: 0.75rem;"><b style="color: var(--accent-primary);">Tiêu chí chấm điểm &amp; Phân tầng năng lực:</b></div>
  <div style="margin: 0.25rem 0; padding-left: 1rem; border-left: 2px solid var(--accent-primary);">• 0đ: Hoảng loạn tiếp tục ngồi mò sửa câu đó hết giờ.</div>
  <div style="margin: 0.25rem 0; padding-left: 1rem; border-left: 2px solid var(--accent-primary);">• 1đ: Nêu được bỏ qua câu đó nhưng chưa rõ việc restore cụm trước khi chuyển.</div>
  <div style="margin: 0.25rem 0; padding-left: 1rem; border-left: 2px solid var(--accent-primary);">• 3đ: Trình bày chuẩn xác quy trình 3 bước xử lý sự cố tâm lý bài thi CKS.</div>
  <div style="margin-top: 0.75rem; padding: 0.5rem 0.75rem; background: rgba(var(--accent-primary-rgb, 59, 130, 246), 0.08); border-radius: 4px;"><b style="color: var(--accent-primary);">Câu hỏi mở rộng / Đào sâu:</b> (Thời gian tối đa nên dành cho 1 câu ở Lượt 1 là bao nhiêu phút? — Tối đa <b style="color: var(--accent-primary);">6 – 8 phút</b> mỗi câu).
...
<summary class="qa-summary">
  <div class="qa-summary-left">
    ...
    <span>Cú pháp bash script chuẩn để thiết lập nhanh 2 alias CLI và cờ dry-run trong tệp <code>~/.bashrc</code> CKS là gì?</span>
  </div>
  <span class="qa-chevron">
    <svg width="18" height="18" fill="none" stroke="currentColor" stroke-width="2.5" viewBox="0 0 24 24"><polyline points="6 9 12 15 18 9"></polyline></svg>
  </span>
...
<div class="qa-answer">
  ...
  <div style="margin: 0.35rem 0; padding-left: 1rem; border-left: 2px solid var(--accent-primary);">alias k=kubectl</div>
  <div style="margin: 0.35rem 0; padding-left: 1rem; border-left: 2px solid var(--accent-primary);">export do="--dry-run=client -o yaml"</div>
  <div style="margin: 0.35rem 0; padding-left: 1rem; border-left: 2px solid var(--accent-primary);">source <(kubectl completion bash)</div>
  <div style="margin: 0.35rem 0; padding-left: 1rem; border-left: 2px solid var(--accent-primary);">complete -o default -F __start_kubectl k</div>
  <div style="margin: 0.35rem 0; padding-left: 1rem; border-left: 2px solid var(--accent-primary);">```</div>
  <div style="margin-top: 0.75rem;"><b style="color: var(--accent-primary);">Tiêu chí chấm điểm &amp; Phân tầng năng lực:</b></div>
  <div style="margin: 0.25rem 0; padding-left: 1rem; border-left: 2px solid var(--accent-primary);">• 0đ: Viết sai alias hoặc sai cờ dry-run.</div>
  <div style="margin: 0.25rem 0; padding-left: 1rem; border-left: 2px solid var(--accent-primary);">• 1đ: Nêu đúng alias k=kubectl nhưng thiếu completion bash.</div>
  <div style="margin: 0.25rem 0; padding-left: 1rem; border-left: 2px solid var(--accent-primary);">• 3đ: Viết chuẩn xác 100% đoạn script thiết lập môi trường CLI tốc độ cao CKS.</div>
  <div style="margin-top: 0.75rem; padding: 0.5rem 0.75rem; background: rgba(var(--accent-primary-rgb, 59, 130, 246), 0.08); border-radius: 4px;"><b style="color: var(--accent-primary);">Câu hỏi mở rộng / Đào sâu:</b> (Cờ <code>complete -o default -F __start_kubectl k</code> có tác dụng gì? — Cho phép dùng phím TAB tự động gợi ý tên tài nguyên khi gõ phím <code>k</code>).
...
<summary class="qa-summary">
  <div class="qa-summary-left">
    ...
    <span>Bộ 4 quy tắc vàng để làm chủ Kỳ thi Chứng chỉ CKS do CNCF tổ chức là gì?</span>
  </div>
  <span class="qa-chevron">
    <svg width="18" height="18" fill="none" stroke="currentColor" stroke-width="2.5" viewBox="0 0 24 24"><polyline points="6 9 12 15 18 9"></polyline></svg>
  </span>
...
<div class="qa-answer">
  ...
  <div style="margin: 0.35rem 0; padding-left: 1rem; border-left: 2px solid var(--accent-primary);">• Luôn gõ <code>kubectl config use-context</code> ở đầu MỌI câu hỏi để làm đúng cụm chỉ định.</div>
  <div style="margin: 0.35rem 0; padding-left: 1rem; border-left: 2px solid var(--accent-primary);">• Sao lưu tệp <code>kube-apiserver.yaml</code> sang <code>/tmp/</code> trước khi chỉnh sửa Control Plane.</div>
  <div style="margin: 0.35rem 0; padding-left: 1rem; border-left: 2px solid var(--accent-primary);">• Khai thác tối đa <code>kubectl --dry-run=client -o yaml</code> và alias CLI để sinh khung YAML trong 15 giây.</div>
  <div style="margin: 0.35rem 0; padding-left: 1rem; border-left: 2px solid var(--accent-primary);">• Áp dụng chiến thuật 3 lượt làm bài 120 phút (Gom trọn điểm câu dễ trước, xử lý câu khó sau).</div>
  <div style="margin-top: 0.75rem;"><b style="color: var(--accent-primary);">Tiêu chí chấm điểm &amp; Phân tầng năng lực:</b></div>
  ...
  <div style="margin: 0.25rem 0; padding-left: 1rem; border-left: 2px solid var(--accent-primary);">• 3đ: Trình bày tự tin, mạch lạc bộ 4 quy tắc vàng CKS Exam Mastery.</div>
  <div style="margin-top: 0.75rem; padding: 0.5rem 0.75rem; background: rgba(var(--accent-primary-rgb, 59, 130, 246), 0.08); border-radius: 4px;"><b style="color: var(--accent-primary);">Câu hỏi mở rộng / Đào sâu:</b> (Mục tiêu tiếp theo của bạn trong Buổi 66 (Giai đoạn 4) là gì? — Học về <code>Tổng ôn CKA Tốc độ: Giải quyết 20 câu bài tập CKA trong 90 phút</code>).

---

## V3. Câu chốt để nói khi phỏng vấn

1. <b style="color: var(--accent-primary);">"Làm chủ ma trận trọng số 6 miền kiến thức CKS và áp dụng chiến thuật 3 lượt làm bài 120 phút."</b>
2. <b style="color: var(--accent-primary);">"Luôn chuyển đúng context cụm (<code>use-context</code>) ở đầu mỗi câu và sao lưu Static Pod <code>kube-apiserver</code>."</b>
3. <b style="color: var(--accent-primary);">"Tăng 300% tốc độ làm bài bằng cờ <code>kubectl --dry-run=client -o yaml</code> và bộ alias CLI chuẩn."</b>
4. <b style="color: var(--accent-primary);">"Tự tin đạt kết quả trên 80/100 điểm ngay trong lần thi CKS đầu tiên do CNCF tổ chức."</b>
...
Trải qua bài **Thi Thử CKS Toàn Diện 120 Phút** giúp bạn cọ xát trực tiếp với áp lực thời gian, tôi luyện kỹ năng gõ lệnh tốc độ và định hình rõ các mảng kiến thức cần củng cố trước khi bước vào kỳ thi chính thức của CNCF.

> [!TIP]
> **BÀI HỌC TIẾP THEO:**
> Trong **[[Bài 21] Tổng Ôn CKS Tốc Độ: 20 Kỹ Thuật Sinh Tử & Mẹo Ăn Điểm Tuyệt Đối](cks-21-21-tong-on-cks-toc-do.html)**, chúng ta sẽ đúc kết toàn bộ bí kíp vàng của cả lộ trình CKS: Bảng tổng hợp các lệnh rút gọn, danh mục template YAML mẫu và chiến thuật tối ưu từng giây trong phòng thi.
{% endraw %}
