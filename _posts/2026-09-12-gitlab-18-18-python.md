...
tldr:
  - "Nắm vững nguyên lý nền tảng và tư duy cốt lõi về Pipeline Chuyên Sâu Cho Python: Poetry / Pipenv Cache, Pytest, Flake8, Black, Bandit & Wheel Packaging."
...
<summary class="qa-summary">
  <div class="qa-summary-left">
    ...
    <span>Môi trường ảo (`venv`) trong một Docker Container Job dùng một lần là THỪA hay BẮT BUỘC? Bạn trả lời bằng một yếu tố quyết định nào và 3 ngoại lệ thực tế nào?</span>
  </div>
