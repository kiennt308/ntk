...
description: "Thiết kế Pipeline hiện đại cho Python & FastAPI: Quản lý dependency với Poetry/uv, kiểm tra chất lượng code với Ruff/Flake8, chạy Pytest song song và đóng gói Docker image mỏng nhẹ."
keywords:
  - gitlab ci python
  - gitlab poetry uv pip cache
  - gitlab pytest ruff lint
  - gitlab fastapi docker
---
