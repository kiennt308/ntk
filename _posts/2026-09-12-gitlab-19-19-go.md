...
---
{% raw %}
# [BÀI 19] CI/CD CHUYÊN SÂU CHO GO (GOLANG): GO MODULES, STATIC COMPILATION, GOLANGCI-LINT & GO TEST
...
<details class="qa-card">
  ...
  <div class="qa-body">
    ...
    <ol>
      <li><strong>Stage Fast Checks</strong>: Chạy song song <code>golangci-lint</code> và <code>go mod verify</code> tại $t_0$ trong dưới 10s.</li>
