...
tldr:
  - "Nắm vững nguyên lý nền tảng và tư duy cốt lõi về Xác Thực OIDC Không Cần Khóa (Keyless Authentication): AWS STS, GCP Workload Identity & Azure Federated Identity."
