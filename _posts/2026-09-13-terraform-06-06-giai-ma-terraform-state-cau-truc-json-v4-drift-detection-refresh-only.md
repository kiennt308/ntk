...
<summary class="qa-summary">
  <div class="qa-summary-left">
    ...
    <span>Số <code>serial</code> trong tệp <code>terraform.tfstate</code> có ý nghĩa gì trong vận hành?</span>
  </div>
...
<div class="qa-answer">
  ...
  <p style="margin: 0.4rem 0;"><code>serial</code> là một số nguyên tăng dần đơn điệu (+1) sau mỗi lần cập nhật State thành công. Nó đóng vai trò là cơ chế kiểm soát phiên bản tương tranh (Optimistic Concurrency Control), giúp Backend phát hiện và ngăn chặn tình trạng ghi đè state cũ hơn khi có nhiều tiến trình chạy song song.</p>
</div>
</details>
...
<summary class="qa-summary">
  <div class="qa-summary-left">
    ...
    <span>Trường <code>lineage</code> trong State Schema v4 đóng vai trò gì?</span>
  </div>
  <span class="qa-chevron">
    <svg width="18" height="18" fill="none" stroke="currentColor" stroke-width="2.5" viewBox="0 0 24 24"><polyline points="6 9 12 15 18 9"></polyline></svg>
  </span>
...
<div class="qa-answer">
  ...
  <p style="margin: 0.4rem 0;"><code>lineage</code> là một chuỗi UUID v4 được sinh ngẫu nhiên khi khởi tạo State lần đầu. Nó định danh "dòng họ" của State file để đảm bảo bạn không vô tình ghi đè State của môi trường này (ví dụ Staging) lên môi trường khác (Production).</p>
</div>
</details>
...
<summary class="qa-summary">
  <div class="qa-summary-left">
    ...
    <span>Vì sao dữ liệu nhạy cảm (<code>sensitive = true</code>) vẫn lưu dưới dạng Plain Text trong State?</span>
  </div>
  <span class="qa-chevron">
    <svg width="18" height="18" fill="none" stroke="currentColor" stroke-width="2.5" viewBox="0 0 24 24"><polyline points="6 9 12 15 18 9"></polyline></svg>
  </span>
...
<div class="qa-answer">
  ...
  <p style="margin: 0.4rem 0;">Vì Terraform Core cần giá trị thực tế của mật khẩu/key để có thể gửi API so sánh Diff với Cloud Provider trong chu trình điều hòa Reconcile Loop. Cờ <code>sensitive = true</code> chỉ có nhiệm vụ che giấu giá trị khi hiển thị trên màn hình CLI và log CI/CD.</p>
</div>
</details>
...
<summary class="qa-summary">
  <div class="qa-summary-left">
    ...
    <span>Sự khác biệt lớn nhất giữa <code>terraform refresh</code> (cũ) và <code>terraform plan -refresh-only</code> (mới) là gì?</span>
  </div>
  <span class="qa-chevron">
    <svg width="18" height="18" fill="none" stroke="currentColor" stroke-width="2.5" viewBox="0 0 24 24"><polyline points="6 9 12 15 18 9"></polyline></svg>
  </span>
...
<summary class="qa-summary">
  <div class="qa-summary-left">
    ...
    <span>Điều gì xảy ra nếu bạn xóa mất tệp <code>terraform.tfstate</code> của một hệ thống đang chạy trên AWS?</span>
  </div>
  <span class="qa-chevron">
    <svg width="18" height="18" fill="none" stroke="currentColor" stroke-width="2.5" viewBox="0 0 24 24"><polyline points="6 9 12 15 18 9"></polyline></svg>
  </span>
...
<div class="qa-answer">
  ...
  <p style="margin: 0.4rem 0;">Các tài nguyên vật lý trên AWS vẫn tiếp tục hoạt động bình thường. Tuy nhiên, Terraform sẽ hoàn toàn mất dấu quyền quản lý. Khi bạn chạy lại <code>terraform apply</code>, nó sẽ cố gắng tạo mới lại từ đầu và báo lỗi xung đột <code>ResourceAlreadyExists</code>. Bạn sẽ phải thực hiện quy trình Import lại từng tài nguyên.</p>
</div>
</details>
...
<div class="qa-answer">
  ...
  <div style="margin: 0.35rem 0; padding-left: 1rem; border-left: 2px solid var(--accent-cyan);"><b style="color: var(--accent-cyan);">1.</b> Bật tính năng mã hóa tại chỗ bằng AWS KMS Customer Managed Key (SSE-KMS).</div>
  <div style="margin: 0.35rem 0; padding-left: 1rem; border-left: 2px solid var(--accent-cyan);"><b style="color: var(--accent-cyan);">2.</b> Bật S3 Versioning để lưu trữ lịch sử và khôi phục khi bị corrupt.</div>
  <div style="margin: 0.35rem 0; padding-left: 1rem; border-left: 2px solid var(--accent-cyan);"><b style="color: var(--accent-cyan);">3.</b> Cấu hình S3 Bucket Policy và IAM Least-Privilege (chỉ cho phép CI/CD runner truy cập).</div>
...
<summary class="qa-summary">
  <div class="qa-summary-left">
    ...
    <span>Trường <code>private</code> dạng Base64 bên trong từng resource instance chứa những gì?</span>
  </div>
  <span class="qa-chevron">
    <svg width="18" height="18" fill="none" stroke="currentColor" stroke-width="2.5" viewBox="0 0 24 24"><polyline points="6 9 12 15 18 9"></polyline></svg>
  </span>
...
<div class="qa-answer">
  ...
  <p style="margin: 0.4rem 0;">Chứa dữ liệu nội bộ riêng của Provider Plugin (như context timeouts, schema version metadata nội bộ). Kỹ sư <b style="color: var(--accent-primary);">tuyệt đối không được chỉnh sửa thủ công</b> trường này để tránh làm hỏng giao tiếp gRPC với Provider.</p>
</div>
</details>
...
<summary class="qa-summary">
  <div class="qa-summary-left">
    ...
    <span>Khi nào một tài nguyên được đánh dấu <code>mode: "data"</code> thay vì <code>mode: "managed"</code>?</span>
  </div>
  <span class="qa-chevron">
    <svg width="18" height="18" fill="none" stroke="currentColor" stroke-width="2.5" viewBox="0 0 24 24"><polyline points="6 9 12 15 18 9"></polyline></svg>
  </span>
...
<div class="qa-answer">
  ...
  <div style="margin: 0.35rem 0; padding-left: 1rem; border-left: 2px solid var(--accent-primary);">• <code>mode: "managed"</code>: Dành cho các tài nguyên khai báo bằng từ khóa <code>resource</code> (Terraform quản lý toàn bộ vòng đời tạo, sửa, xóa).</div>
...
<summary class="qa-summary">
  <div class="qa-summary-left">
    ...
    <span>Lệnh <code>terraform state list</code> và <code>terraform state show &lt;address&gt;</code> dùng để làm gì?</span>
  </div>
  <span class="qa-chevron">
    <svg width="18" height="18" fill="none" stroke="currentColor" stroke-width="2.5" viewBox="0 0 24 24"><polyline points="6 9 12 15 18 9"></polyline></svg>
  </span>
...
<div class="qa-answer">
  ...
  <div style="margin: 0.35rem 0; padding-left: 1rem; border-left: 2px solid var(--accent-primary);">• <code>terraform state list</code>: Liệt kê danh sách địa chỉ của toàn bộ tài nguyên hiện có trong State.</div>
...
<summary class="qa-summary">
  <div class="qa-summary-left">
    ...
    <span>Tại sao không bao giờ được commit tệp <code>terraform.tfstate</code> lên Git Repository công khai?</span>
  </div>
  <span class="qa-chevron">
    <svg width="18" height="18" fill="none" stroke="currentColor" stroke-width="2.5" viewBox="0 0 24 24"><polyline points="6 9 12 15 18 9"></polyline></svg>
  </span>
...
<div class="qa-answer">
  ...
  <p style="margin: 0.4rem 0;">Vì State File chứa toàn bộ thông tin nhạy cảm của hạ tầng ở dạng Plain Text (Database Passwords, TLS Private Keys, IAM Credentials, Internal IPs), đồng thời dễ dẫn tới xung đột merge conflict khi nhiều kỹ sư cùng làm việc. Luôn phải sử dụng Remote State Backend.</p>
</div>
</details>
