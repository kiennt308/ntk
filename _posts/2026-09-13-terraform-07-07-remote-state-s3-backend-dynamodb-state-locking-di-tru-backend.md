...
<div style="margin: 0.35rem 0; padding-left: 1rem; border-left: 2px solid var(--accent-primary);">• <code>-migrate-state</code>: Tự động sao chép toàn bộ dữ liệu State hiện tại sang Backend mới và xóa state cũ sau khi xác nhận.<br/></div>
