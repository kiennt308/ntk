...
<div style="margin: 0.35rem 0; padding-left: 1rem; border-left: 2px solid var(--accent-cyan);"><b style="color: var(--accent-cyan);">1.</b> <b style="color: var(--accent-primary);">Tính Declarative:</b> Được lưu trong mã nguồn Git, có thể review qua Pull Request.<br/></div>
  <div style="margin: 0.35rem 0; padding-left: 1rem; border-left: 2px solid var(--accent-cyan);"><b style="color: var(--accent-cyan);">2.</b> <b style="color: var(--accent-primary);">Tự động hóa trong CI/CD:</b> Pipeline tự động di chuyển state khi apply mà không cần kỹ sư can thiệp SSH chạy lệnh thủ công.<br/></div>
