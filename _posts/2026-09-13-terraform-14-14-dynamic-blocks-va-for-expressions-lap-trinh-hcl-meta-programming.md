...
<div style="margin: 0.35rem 0; padding-left: 1rem; border-left: 2px solid var(--accent-primary);">• <code>for_each</code> ở cấp resource dùng để sinh ra <b style="color: var(--accent-primary);">nhiều tài nguyên độc lập</b> (mỗi tài nguyên có State Address riêng).<br/></div>
