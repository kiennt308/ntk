...
flowchart TD
    ...
    style ERR3 fill:none,stroke:#ff0000,stroke-width:2px
...
<summary class="qa-summary">
  <div class="qa-summary-left">
    ...
    <span>Điểm khác biệt mấu chốt giữa <code>type = any</code> và <code>type = object({...})</code> là gì?</span>
  </div>
...
<div class="qa-answer">
  ...
  <p style="margin: 0.4rem 0;"><code>type = any</code> đóng vai trò là wildcard, tắt toàn bộ cơ chế type checking tại thời điểm parse HCL, dễ dẫn đến lỗi runtime nếu module truy cập thuộc tính không tồn tại. <code>type = object({...})</code> định nghĩa hợp đồng dữ liệu (data contract) tường minh, hỗ trợ kiểm tra kiểu của từng trường con, bắt buộc truyền đủ thuộc tính (trừ khi có <code>optional()</code>), giúp phát hiện lỗi sai cấu trúc ngay lập tức.</p>
</div>
</details>
...
<summary class="qa-summary">
  <div class="qa-summary-left">
    ...
    <span>Khối <code>validation</code> trong biến số có thể tham chiếu (reference) tới các biến số khác trong cùng module không?</span>
  </div>
  <span class="qa-chevron">
    <svg width="18" height="18" fill="none" stroke="currentColor" stroke-width="2.5" viewBox="0 0 24 24"><polyline points="6 9 12 15 18 9"></polyline></svg>
  </span>
...
<summary class="qa-summary">
  <div class="qa-summary-left">
    ...
    <span>Đoạn code <code>can(regex("^[0-9]+$", var.age))</code> hoạt động như thế nào khi <code>var.age</code> là <code>null</code> hoặc chuỗi <code>"abc"</code>?</span>
  </div>
  <span class="qa-chevron">
    <svg width="18" height="18" fill="none" stroke="currentColor" stroke-width="2.5" viewBox="0 0 24 24"><polyline points="6 9 12 15 18 9"></polyline></svg>
  </span>
...
<summary class="qa-summary">
  <div class="qa-summary-left">
    ...
    <span>Sự khác nhau giữa <code>alltrue([for item in list: condition])</code> và <code>contains(list, value)</code>?</span>
  </div>
  <span class="qa-chevron">
    <svg width="18" height="18" fill="none" stroke="currentColor" stroke-width="2.5" viewBox="0 0 24 24"><polyline points="6 9 12 15 18 9"></polyline></svg>
  </span>
...
<summary class="qa-summary">
  <div class="qa-summary-left">
    ...
    <span>Khi nào nên sử dụng <code>precondition</code> và <code>postcondition</code> thay vì Variable Validation?</span>
  </div>
  <span class="qa-chevron">
    <svg width="18" height="18" fill="none" stroke="currentColor" stroke-width="2.5" viewBox="0 0 24 24"><polyline points="6 9 12 15 18 9"></polyline></svg>
  </span>
...
<summary class="qa-summary">
  <div class="qa-summary-left">
    ...
    <span>Tại sao nên ưu tiên dùng <code>formatlist()</code> hoặc <code>for</code> expression thay vì hardcode string concatenation?</span>
  </div>
  <span class="qa-chevron">
    <svg width="18" height="18" fill="none" stroke="currentColor" stroke-width="2.5" viewBox="0 0 24 24"><polyline points="6 9 12 15 18 9"></polyline></svg>
  </span>
...
<div class="qa-answer">
  ...
  <p style="margin: 0.4rem 0;"><code>formatlist()</code> và <code>for</code> expressions hỗ trợ xử lý linh hoạt các mảng có kích thước động, tự động áp dụng hàm biến đổi cho từng phần tử mà không gây lỗi index out of range, đồng thời giúp code HCL giữ vững nguyên lý Declarative.</p>
</div>
</details>
...
<summary class="qa-summary">
  <div class="qa-summary-left">
    ...
    <span>Hàm <code>compact()</code> loại bỏ những phần tử nào trong một danh sách?</span>
  </div>
  <span class="qa-chevron">
    <svg width="18" height="18" fill="none" stroke="currentColor" stroke-width="2.5" viewBox="0 0 24 24"><polyline points="6 9 12 15 18 9"></polyline></svg>
  </span>
...
<div class="qa-answer">
  ...
  <p style="margin: 0.4rem 0;"><code>compact()</code> chỉ nhận đầu vào là <code>list(string)</code> và loại bỏ tất cả các phần tử là <b style="color: var(--accent-primary);">chuỗi rỗng <code>""</code></b> hoặc <code>null</code>. Nó không loại bỏ số 0 hay boolean false.</p>
</div>
</details>
...
<summary class="qa-summary">
  <div class="qa-summary-left">
    ...
    <span>Làm thế nào để kiểm tra một biến kiểu <code>map(string)</code> không chứa bất kỳ key nào bắt đầu bằng từ khóa <code>"aws:"</code>?</span>
  </div>
  <span class="qa-chevron">
    <svg width="18" height="18" fill="none" stroke="currentColor" stroke-width="2.5" viewBox="0 0 24 24"><polyline points="6 9 12 15 18 9"></polyline></svg>
  </span>
...
<div class="qa-answer">
  ...
  <p style="margin: 0.4rem 0;"></p>
  <pre style="background: rgba(0,0,0,0.35); padding: 0.75rem 1rem; border-radius: 6px; border: 1px solid var(--border-color); font-size: 0.85rem; overflow-x: auto; margin: 0.5rem 0;"><code class="language-hcl">validation {
  condition = alltrue([
...
<summary class="qa-summary">
  <div class="qa-summary-left">
    ...
    <span>Điều gì xảy ra nếu hàm <code>try(local.a, local.b)</code> có <code>local.a</code> chứa syntax error (sai cú pháp HCL)?</span>
  </div>
  <span class="qa-chevron">
    <svg width="18" height="18" fill="none" stroke="currentColor" stroke-width="2.5" viewBox="0 0 24 24"><polyline points="6 9 12 15 18 9"></polyline></svg>
  </span>
...
<summary class="qa-summary">
  <div class="qa-summary-left">
    ...
    <span>Làm thế nào để thiết lập một giá trị mặc định phức tạp cho biến <code>object</code> mà trong đó có thuộc tính lồng nhau (nested optional attributes)?</span>
  </div>
  <span class="qa-chevron">
    <svg width="18" height="18" fill="none" stroke="currentColor" stroke-width="2.5" viewBox="0 0 24 24"><polyline points="6 9 12 15 18 9"></polyline></svg>
  </span>
...
<div class="qa-answer">
  ...
  <p style="margin: 0.4rem 0;">Sử dụng cú pháp <code>optional(type, default_value)</code> ở mọi cấp lồng nhau trong định nghĩa <code>type</code> của biến. Ví dụ: <code>type = object({ db = optional(object({ port = optional(number, 5432) }), {}) })</code>.</p>
</div>
</details>
