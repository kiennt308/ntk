# Paper Note: OA_KW4_049

**Title:** MAtt: A Manifold Attention Network for EEG Decoding  
**Authors:** Yueting Pan, Jing-Lun Chou, Chun-Shu Wei  
**Year:** 2022 | **Venue:** arXiv (Cornell University)  
**DOI:** [10.48550/arxiv.2210.01986](https://doi.org/10.48550/arxiv.2210.01986) | **Open Access PDF:** [https://arxiv.org/pdf/2210.01986.pdf](https://arxiv.org/pdf/2210.01986.pdf)  
**Cluster:** KW04 - Subspace Disentanglement & Domain Adaptation

---

## 1. Executive Summary & Problem Formulation
- **Objective**: MAtt: A Manifold Attention Network for EEG Decoding.
