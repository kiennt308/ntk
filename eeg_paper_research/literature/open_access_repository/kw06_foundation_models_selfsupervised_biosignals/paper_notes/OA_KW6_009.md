...
**Authors:** Bálint Tóth, Dominik Senti, Thorir Mar Ingolfsson et al.  
**Year:** 2025 | **Venue:** arXiv Preprint  
**DOI:** [10.48550/arXiv.2502.17460v2](https://doi.org/10.48550/arXiv.2502.17460v2) | **Open Access PDF:** [https://arxiv.org/pdf/2502.17460v2.pdf](https://arxiv.org/pdf/2502.17460v2.pdf)  
**Cluster:** KW06 - Foundation Models & Self-Supervised Biosignals

---

## 1. Executive Summary & Problem Formulation
- **Objective**: Finetuning and Quantization of EEG-Based Foundational BioSignal Models on ECG and PPG Data for Blood Pressure Estimation.
