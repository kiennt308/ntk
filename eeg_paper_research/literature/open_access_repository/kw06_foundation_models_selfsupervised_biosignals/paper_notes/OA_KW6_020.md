# Paper Note: OA_KW6_020

**Title:** Neuro-GPT: Towards A Foundation Model for EEG  
**Authors:** Wenhui Cui, Woojae Jeong, Philipp Thölke et al.  
**Year:** 2023 | **Venue:** arXiv Preprint  
**DOI:** [10.48550/arXiv.2311.03764v4](https://doi.org/10.48550/arXiv.2311.03764v4) | **Open Access PDF:** [https://arxiv.org/pdf/2311.03764v4.pdf](https://arxiv.org/pdf/2311.03764v4.pdf)  
**Cluster:** KW06 - Foundation Models & Self-Supervised Biosignals

---

## 1. Executive Summary & Problem Formulation
- **Objective**: Neuro-GPT: Towards A Foundation Model for EEG.
