# Paper Note: OA_KW6_035

**Title:** The Case for Cleaner Biosignals: High-fidelity Neural Compressor Enables Transfer from Cleaner iEEG to Noisier EEG  
**Authors:** Francesco Stefano Carzaniga, Gary Tom Hoppeler, Michael Hersche et al.  
**Year:** 2025 | **Venue:** arXiv Preprint  
**DOI:** [10.48550/arXiv.2502.17462v1](https://doi.org/10.48550/arXiv.2502.17462v1) | **Open Access PDF:** [https://arxiv.org/pdf/2502.17462v1.pdf](https://arxiv.org/pdf/2502.17462v1.pdf)  
**Cluster:** KW06 - Foundation Models & Self-Supervised Biosignals

---

## 1. Executive Summary & Problem Formulation
- **Objective**: The Case for Cleaner Biosignals: High-fidelity Neural Compressor Enables Transfer from Cleaner iEEG to Noisier EEG.
