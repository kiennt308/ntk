# Paper Note: OA_KW6_037

**Title:** Real-Time Seizure Detection using EEG: A Comprehensive Comparison of Recent Approaches under a Realistic Setting  
**Authors:** Kwanhyung Lee, Hyewon Jeong, Seyun Kim et al.  
**Year:** 2022 | **Venue:** arXiv Preprint  
**DOI:** [10.48550/arXiv.2201.08780v2](https://doi.org/10.48550/arXiv.2201.08780v2) | **Open Access PDF:** [https://arxiv.org/pdf/2201.08780v2.pdf](https://arxiv.org/pdf/2201.08780v2.pdf)  
**Cluster:** KW06 - Foundation Models & Self-Supervised Biosignals

---

## 1. Executive Summary & Problem Formulation
- **Objective**: Real-Time Seizure Detection using EEG: A Comprehensive Comparison of Recent Approaches under a Realistic Setting.
