# Paper Note: OA_KW6_042

**Title:** On the Workflows and Smells of Leaderboard Operations (LBOps): An Exploratory Study of Foundation Model Leaderboards  
**Authors:** Zhimin Zhao, Abdul Ali Bangash, Filipe Roseiro Côgo et al.  
**Year:** 2024 | **Venue:** arXiv Preprint  
**DOI:** [10.48550/arXiv.2407.04065v4](https://doi.org/10.48550/arXiv.2407.04065v4) | **Open Access PDF:** [https://arxiv.org/pdf/2407.04065v4.pdf](https://arxiv.org/pdf/2407.04065v4.pdf)  
**Cluster:** KW06 - Foundation Models & Self-Supervised Biosignals

---

## 1. Executive Summary & Problem Formulation
- **Objective**: On the Workflows and Smells of Leaderboard Operations (LBOps): An Exploratory Study of Foundation Model Leaderboards.
