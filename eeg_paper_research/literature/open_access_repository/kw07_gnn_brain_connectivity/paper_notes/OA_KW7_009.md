# Paper Note: OA_KW7_009

**Title:** Graph Neural Network Training Systems: A Performance Comparison of Full-Graph and Mini-Batch  
**Authors:** Saurabh Bajaj, Hojae Son, Juelin Liu et al.  
**Year:** 2024 | **Venue:** arXiv Preprint  
**DOI:** [10.48550/arXiv.2406.00552v4](https://doi.org/10.48550/arXiv.2406.00552v4) | **Open Access PDF:** [https://arxiv.org/pdf/2406.00552v4.pdf](https://arxiv.org/pdf/2406.00552v4.pdf)  
**Cluster:** KW07 - Graph Neural Networks & Brain Connectivity

---

## 1. Executive Summary & Problem Formulation
- **Objective**: Graph Neural Network Training Systems: A Performance Comparison of Full-Graph and Mini-Batch.
