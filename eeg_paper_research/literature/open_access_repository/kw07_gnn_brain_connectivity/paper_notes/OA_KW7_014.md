# Paper Note: OA_KW7_014

**Title:** SSGCNet: A Sparse Spectra Graph Convolutional Network for Epileptic EEG Signal Classification  
**Authors:** Jialin Wang, Rui Gao, Haotian Zheng et al.  
**Year:** 2022 | **Venue:** arXiv Preprint  
**DOI:** [10.48550/arXiv.2203.12910v1](https://doi.org/10.48550/arXiv.2203.12910v1) | **Open Access PDF:** [https://arxiv.org/pdf/2203.12910v1.pdf](https://arxiv.org/pdf/2203.12910v1.pdf)  
**Cluster:** KW07 - Graph Neural Networks & Brain Connectivity

---

## 1. Executive Summary & Problem Formulation
- **Objective**: SSGCNet: A Sparse Spectra Graph Convolutional Network for Epileptic EEG Signal Classification.
