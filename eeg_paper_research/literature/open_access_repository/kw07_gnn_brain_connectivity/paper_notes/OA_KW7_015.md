# Paper Note: OA_KW7_015

**Title:** Atom: Neural Traffic Compression with Spatio-Temporal Graph Neural Networks  
**Authors:** Paul Almasan, Krzysztof Rusek, Shihan Xiao et al.  
**Year:** 2023 | **Venue:** arXiv Preprint  
**DOI:** [10.48550/arXiv.2311.05337v1](https://doi.org/10.48550/arXiv.2311.05337v1) | **Open Access PDF:** [https://arxiv.org/pdf/2311.05337v1.pdf](https://arxiv.org/pdf/2311.05337v1.pdf)  
**Cluster:** KW07 - Graph Neural Networks & Brain Connectivity

---

## 1. Executive Summary & Problem Formulation
- **Objective**: Atom: Neural Traffic Compression with Spatio-Temporal Graph Neural Networks.
