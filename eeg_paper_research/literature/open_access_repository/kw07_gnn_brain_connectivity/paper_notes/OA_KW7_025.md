# Paper Note: OA_KW7_025

**Title:** Adaptive Gated Graph Convolutional Network for Explainable Diagnosis of Alzheimer's Disease using EEG Data  
**Authors:** Dominik Klepl, Fei He, Min Wu et al.  
**Year:** 2023 | **Venue:** arXiv Preprint  
**DOI:** [10.48550/arXiv.2304.05874v3](https://doi.org/10.48550/arXiv.2304.05874v3) | **Open Access PDF:** [https://arxiv.org/pdf/2304.05874v3.pdf](https://arxiv.org/pdf/2304.05874v3.pdf)  
**Cluster:** KW07 - Graph Neural Networks & Brain Connectivity

---

## 1. Executive Summary & Problem Formulation
- **Objective**: Adaptive Gated Graph Convolutional Network for Explainable Diagnosis of Alzheimer's Disease using EEG Data.
