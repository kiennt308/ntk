# Paper Note: OA_KW7_026

**Title:** PGCN: Pyramidal Graph Convolutional Network for EEG Emotion Recognition  
**Authors:** Ming Jin, Enwei Zhu, Changde Du et al.  
**Year:** 2023 | **Venue:** arXiv Preprint  
**DOI:** [10.48550/arXiv.2302.02520v1](https://doi.org/10.48550/arXiv.2302.02520v1) | **Open Access PDF:** [https://arxiv.org/pdf/2302.02520v1.pdf](https://arxiv.org/pdf/2302.02520v1.pdf)  
**Cluster:** KW07 - Graph Neural Networks & Brain Connectivity

---

## 1. Executive Summary & Problem Formulation
- **Objective**: PGCN: Pyramidal Graph Convolutional Network for EEG Emotion Recognition.
