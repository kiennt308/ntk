# Paper Note: OA_KW7_032

**Title:** Inter Subject Emotion Recognition Using Spatio-Temporal Features From EEG Signal  
**Authors:** Mohammad Asif, Diya Srivastava, Aditya Gupta et al.  
**Year:** 2023 | **Venue:** arXiv Preprint  
**DOI:** [10.48550/arXiv.2305.19379v1](https://doi.org/10.48550/arXiv.2305.19379v1) | **Open Access PDF:** [https://arxiv.org/pdf/2305.19379v1.pdf](https://arxiv.org/pdf/2305.19379v1.pdf)  
**Cluster:** KW07 - Graph Neural Networks & Brain Connectivity

---

## 1. Executive Summary & Problem Formulation
- **Objective**: Inter Subject Emotion Recognition Using Spatio-Temporal Features From EEG Signal.
