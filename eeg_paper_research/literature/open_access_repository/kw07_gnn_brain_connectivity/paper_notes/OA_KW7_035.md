# Paper Note: OA_KW7_035

**Title:** SpoT-Mamba: Learning Long-Range Dependency on Spatio-Temporal Graphs with Selective State Spaces  
**Authors:** Jinhyeok Choi, Heehyeon Kim, Minhyeong An et al.  
**Year:** 2024 | **Venue:** arXiv Preprint  
**DOI:** [10.48550/arXiv.2406.11244v1](https://doi.org/10.48550/arXiv.2406.11244v1) | **Open Access PDF:** [https://arxiv.org/pdf/2406.11244v1.pdf](https://arxiv.org/pdf/2406.11244v1.pdf)  
**Cluster:** KW07 - Graph Neural Networks & Brain Connectivity

---

## 1. Executive Summary & Problem Formulation
- **Objective**: SpoT-Mamba: Learning Long-Range Dependency on Spatio-Temporal Graphs with Selective State Spaces.
