# Paper Note: OA_KW7_037

**Title:** Covariance Spectrum in Nonlinear Recurrent Neural Networks: A Near-Critical Effective Connection Strength Throughout Chaos  
**Authors:** Xuanyu Shen, Yu Hu  
**Year:** 2025 | **Venue:** arXiv Preprint  
**DOI:** [10.48550/arXiv.2508.05288v2](https://doi.org/10.48550/arXiv.2508.05288v2) | **Open Access PDF:** [https://arxiv.org/pdf/2508.05288v2.pdf](https://arxiv.org/pdf/2508.05288v2.pdf)  
**Cluster:** KW07 - Graph Neural Networks & Brain Connectivity

---

## 1. Executive Summary & Problem Formulation
- **Objective**: Covariance Spectrum in Nonlinear Recurrent Neural Networks: A Near-Critical Effective Connection Strength Throughout Chaos.
