# Paper Note: OA_KW7_041

**Title:** Spatio-Temporal Directed Graph Learning for Account Takeover Fraud Detection  
**Authors:** Mohsen Nayebi Kerdabadi, William Andrew Byron, Xin Sun et al.  
**Year:** 2025 | **Venue:** arXiv Preprint  
**DOI:** [10.48550/arXiv.2509.20339v1](https://doi.org/10.48550/arXiv.2509.20339v1) | **Open Access PDF:** [https://arxiv.org/pdf/2509.20339v1.pdf](https://arxiv.org/pdf/2509.20339v1.pdf)  
**Cluster:** KW07 - Graph Neural Networks & Brain Connectivity

---

## 1. Executive Summary & Problem Formulation
- **Objective**: Spatio-Temporal Directed Graph Learning for Account Takeover Fraud Detection.
