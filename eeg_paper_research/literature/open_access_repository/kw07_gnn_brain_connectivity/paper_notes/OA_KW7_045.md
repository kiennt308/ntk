# Paper Note: OA_KW7_045

**Title:** Learning Task-Aware Effective Brain Connectivity for fMRI Analysis with Graph Neural Networks  
**Authors:** Yue Yu, Xuan Kan, Hejie Cui et al.  
**Year:** 2022 | **Venue:** arXiv Preprint  
**DOI:** [10.48550/arXiv.2211.00261v1](https://doi.org/10.48550/arXiv.2211.00261v1) | **Open Access PDF:** [https://arxiv.org/pdf/2211.00261v1.pdf](https://arxiv.org/pdf/2211.00261v1.pdf)  
**Cluster:** KW07 - Graph Neural Networks & Brain Connectivity

---

## 1. Executive Summary & Problem Formulation
- **Objective**: Learning Task-Aware Effective Brain Connectivity for fMRI Analysis with Graph Neural Networks.
