# Paper Note: OA_KW9_040

**Title:** SVFAP: Self-supervised Video Facial Affect Perceiver  
**Authors:** Licai Sun, Zheng Lian, Kexin Wang et al.  
**Year:** 2023 | **Venue:** arXiv Preprint  
**DOI:** [10.48550/arXiv.2401.00416v2](https://doi.org/10.48550/arXiv.2401.00416v2) | **Open Access PDF:** [https://arxiv.org/pdf/2401.00416v2.pdf](https://arxiv.org/pdf/2401.00416v2.pdf)  
**Cluster:** KW09 - Explainable AI & Interpretable Biosignals

---

## 1. Executive Summary & Problem Formulation
- **Objective**: SVFAP: Self-supervised Video Facial Affect Perceiver.
