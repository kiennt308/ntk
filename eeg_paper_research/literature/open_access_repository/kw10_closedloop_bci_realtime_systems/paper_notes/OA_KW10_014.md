...
**Year:** 2023 | **Pages:** 8  
**PDF File:** `OA_KW10_014.pdf`  
**MD5 Hash:** `cb6445dbd327092bf5453cc0e1b4b416`  
**Cluster:** KW10 - Closed-Loop BCI & Real-Time Affective Systems

---

## 1. Executive Summary & Problem Formulation
- **Objective**: 2021 9th International Conference on Affective Computing and Intelligent Interaction (ACII).
