# Paper Note: OA_KW10_016

**Title:** Designing Mobile EEG Neurofeedback Games for Children with Autism  
**Authors:** Affective Computing & BCI Research Group  
**Year:** 2023 | **Pages:** 9  
**PDF File:** `OA_KW10_016.pdf`  
**MD5 Hash:** `17e09db8780ebae69acd690ab57bffd3`  
**Cluster:** KW10 - Closed-Loop BCI & Real-Time Affective Systems

---

## 1. Executive Summary & Problem Formulation
- **Objective**: Designing Mobile EEG Neurofeedback Games for Children with Autism.
