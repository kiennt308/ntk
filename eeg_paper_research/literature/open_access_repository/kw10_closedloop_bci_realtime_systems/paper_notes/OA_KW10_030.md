# Paper Note: OA_KW10_030

**Title:** Regional Attention Network (RAN) for Head  
**Authors:** Affective Computing & BCI Research Group  
**Year:** 2023 | **Pages:** 14  
**PDF File:** `OA_KW10_030.pdf`  
**MD5 Hash:** `ada49a68efd556c1108cd8e983a7de96`  
**Cluster:** KW10 - Closed-Loop BCI & Real-Time Affective Systems

---

## 1. Executive Summary & Problem Formulation
- **Objective**: Regional Attention Network (RAN) for Head.
