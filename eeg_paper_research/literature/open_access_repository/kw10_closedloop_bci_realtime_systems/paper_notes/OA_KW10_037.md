# Paper Note: OA_KW10_037

**Title:** TOW ARDS GAZE-INDEPENDENT C-VEP BCI: A PILOT STUDY  
**Authors:** Affective Computing & BCI Research Group  
**Year:** 2023 | **Pages:** 6  
**PDF File:** `OA_KW10_037.pdf`  
**MD5 Hash:** `4fc74dae55e68d29c6ef1b622272a811`  
**Cluster:** KW10 - Closed-Loop BCI & Real-Time Affective Systems

---

## 1. Executive Summary & Problem Formulation
- **Objective**: TOW ARDS GAZE-INDEPENDENT C-VEP BCI: A PILOT STUDY.
