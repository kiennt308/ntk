...
**Authors:** Riccardo Gervasi  
**Year:** 2023 | **Pages:** 15  
**PDF File:** `OA_KW1_020.pdf`  
**MD5 Hash:** `6781975847bbfadf4234e5fdf49867bc`  
**Cluster:** KW01 - Multimodal EEG & Peripheral Biosignals

---

## 1. Executive Summary & Problem Formulation
- **Objective**: Analyzing psychophysical state and cognitive performance in human-robot collaboration for repetitive assembly processes.
