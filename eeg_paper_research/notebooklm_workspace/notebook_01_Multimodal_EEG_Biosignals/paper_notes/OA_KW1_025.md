# Paper Note: OA_KW1_025

**Title:** Affective state estimation based on Russell’s model and physiological measurements  
**Authors:** Roberto Cittadini  
**Year:** 2023 | **Pages:** 14  
**PDF File:** `OA_KW1_025.pdf`  
**MD5 Hash:** `09e37001c94465844c92c3bd03df6792`  
**Cluster:** KW01 - Multimodal EEG & Peripheral Biosignals

---

## 1. Executive Summary & Problem Formulation
- **Objective**: Affective state estimation based on Russell’s model and physiological measurements.
