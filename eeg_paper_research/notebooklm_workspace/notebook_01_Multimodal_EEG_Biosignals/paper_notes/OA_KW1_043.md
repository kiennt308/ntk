# Paper Note: OA_KW1_043

**Title:** HADUA: Hierarchical Attention and Dynamic Uniform Alignment for Robust Cross-Subject Emotion Recognition  
**Authors:** Jiahao Tang; Youjun Li; Yangxuan Zheng; Xiangting Fan; Siyuan Lu; Nuo Zhang; Zi-Gang Huang  
**Year:** 2023 | **Pages:** 14  
**PDF File:** `OA_KW1_043.pdf`  
**MD5 Hash:** `279910810693a2377c9c12bbece572e7`  
**Cluster:** KW01 - Multimodal EEG & Peripheral Biosignals

---

## 1. Executive Summary & Problem Formulation
- **Objective**: HADUA: Hierarchical Attention and Dynamic Uniform Alignment for Robust Cross-Subject Emotion Recognition.
