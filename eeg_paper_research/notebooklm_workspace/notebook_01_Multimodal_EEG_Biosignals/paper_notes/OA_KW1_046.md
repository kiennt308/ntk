# Paper Note: OA_KW1_046

**Title:** MAD: A Multimodal and Multi-perspective Affective Dataset with Hierarchical Annotations  
**Authors:** Shengwei Guo; Yunqing Qiao; Wenzhan Zhang; Bo Liu; Yong Wang; Guobing Sun  
**Year:** 2023 | **Pages:** 12  
**PDF File:** `OA_KW1_046.pdf`  
**MD5 Hash:** `5ecf5eef2041ca9284d446ecc76747c1`  
**Cluster:** KW01 - Multimodal EEG & Peripheral Biosignals

---

## 1. Executive Summary & Problem Formulation
- **Objective**: MAD: A Multimodal and Multi-perspective Affective Dataset with Hierarchical Annotations.
