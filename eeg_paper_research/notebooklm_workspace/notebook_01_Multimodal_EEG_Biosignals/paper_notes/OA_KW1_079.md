# Paper Note: OA_KW1_079

**Title:** Sequential Contextual Fit Predicts Human Behavioural and Neural Dynamics Across Domains  
**Authors:** Kun Sun; Rong Wang  
**Year:** 2026 | **Journal / Venue:** arXiv Preprints (Affective Computing & Neural Systems)  
**DOI:** `10.48550/arXiv.2609.20179v1`  
**PDF File:** `OA_KW1_079.pdf`  
**MD5 Hash:** `86e6459a61db2c3870bef4f85e2ed6d1`  
**Cluster:** KW01 - Multimodal EEG & Peripheral Biosignals

---

## 1. Executive Summary & Problem Formulation
- **Research Objective**: Sequential Contextual Fit Predicts Human Behavioural and Neural Dynamics Across Domains
