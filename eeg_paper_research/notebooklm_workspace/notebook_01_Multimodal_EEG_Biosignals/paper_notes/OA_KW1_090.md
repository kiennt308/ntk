...
**DOI:** `10.48550/arXiv.2606.28202v1`  
**PDF File:** `OA_KW1_090.pdf`  
**MD5 Hash:** `98ce9b6704b0c2589cd568474a2cb98d`  
**Cluster:** KW01 - Multimodal EEG & Peripheral Biosignals

---

## 1. Executive Summary & Problem Formulation
- **Research Objective**: An Enhanced Source-Free Unsupervised Domain Adaptation Framework for Cross-Dataset EEG Emotion Recognition via Predictive Coding and Test-Time Training
