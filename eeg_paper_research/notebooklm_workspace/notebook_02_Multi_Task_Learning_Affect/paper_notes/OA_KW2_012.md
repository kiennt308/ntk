# Paper Note: OA_KW2_012

**Title:** EEGformer: A transformer–based brain activity classification method using EEG signal  
**Authors:** Zhijiang Wan  
**Year:** 2023 | **Pages:** 13  
**PDF File:** `OA_KW2_012.pdf`  
**MD5 Hash:** `1b3bd92134f42c7bda18d766d936a7f0`  
**Cluster:** KW02 - Multi-Task Learning & Multi-Dimensional Affect

---

## 1. Executive Summary & Problem Formulation
- **Objective**: EEGformer: A transformer–based brain activity classification method using EEG signal.
