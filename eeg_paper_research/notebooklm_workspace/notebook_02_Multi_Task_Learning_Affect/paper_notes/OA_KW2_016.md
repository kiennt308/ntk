...
**Year:** 2023 | **Pages:** 8  
**PDF File:** `OA_KW2_016.pdf`  
**MD5 Hash:** `6f603c63a6a25d4b51727eb5292385af`  
**Cluster:** KW02 - Multi-Task Learning & Multi-Dimensional Affect

---

## 1. Executive Summary & Problem Formulation
- **Objective**: NeuroCoreX: An Open-Source FPGA-Based Spiking Neural Network Emulator with On-Chip Learning.
