# Paper Note: OA_KW2_025

**Title:** Emotion recognition with EEG-based brain-computer interfaces: a systematic literature review  
**Authors:** Kübra Erat  
**Year:** 2023 | **Pages:** 48  
**PDF File:** `OA_KW2_025.pdf`  
**MD5 Hash:** `8ff4da1e9d2707c936c57f4bbfc24c61`  
**Cluster:** KW02 - Multi-Task Learning & Multi-Dimensional Affect

---

## 1. Executive Summary & Problem Formulation
- **Objective**: Emotion recognition with EEG-based brain-computer interfaces: a systematic literature review.
