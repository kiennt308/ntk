# Paper Note: OA_KW2_026

**Title:** Emotion recognition based on multi-modal physiological signals and transfer learning  
**Authors:** Xinrun He  
**Year:** 2023 | **Pages:** 15  
**PDF File:** `OA_KW2_026.pdf`  
**MD5 Hash:** `58bf39d267b536d570d5d4842abf77a0`  
**Cluster:** KW02 - Multi-Task Learning & Multi-Dimensional Affect

---

## 1. Executive Summary & Problem Formulation
- **Objective**: Emotion recognition based on multi-modal physiological signals and transfer learning.
