# Paper Note: OA_KW2_027

**Title:** EEG emotion recognition based on differential entropy feature matrix through 2D-CNN-LSTM network  
**Authors:** Teng Wang  
**Year:** 2023 | **Pages:** 19  
**PDF File:** `OA_KW2_027.pdf`  
**MD5 Hash:** `2b2b58d360f8f4913a1f7cdbac469657`  
**Cluster:** KW02 - Multi-Task Learning & Multi-Dimensional Affect

---

## 1. Executive Summary & Problem Formulation
- **Objective**: EEG emotion recognition based on differential entropy feature matrix through 2D-CNN-LSTM network.
