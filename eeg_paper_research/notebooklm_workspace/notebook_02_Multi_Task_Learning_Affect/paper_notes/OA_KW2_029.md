# Paper Note: OA_KW2_029

**Title:** Weakly-supervised Learning for Fine-grained  
**Authors:** Affective Biosignals Research Consortium  
**Year:** 2023 | **Pages:** 18  
**PDF File:** `OA_KW2_029.pdf`  
**MD5 Hash:** `e7fea7707a7151f7ec764e5f75a84c78`  
**Cluster:** KW02 - Multi-Task Learning & Multi-Dimensional Affect

---

## 1. Executive Summary & Problem Formulation
- **Objective**: Weakly-supervised Learning for Fine-grained.
