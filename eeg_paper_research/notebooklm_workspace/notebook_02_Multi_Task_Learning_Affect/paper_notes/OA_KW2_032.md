# Paper Note: OA_KW2_032

**Title:** Adaptive neuro-fuzzy based hybrid classification model for emotion recognition from EEG signals  
**Authors:** F. Kebire Bardak  
**Year:** 2023 | **Pages:** 14  
**PDF File:** `OA_KW2_032.pdf`  
**MD5 Hash:** `88e6d2d236d146608c244721bf077c00`  
**Cluster:** KW02 - Multi-Task Learning & Multi-Dimensional Affect

---

## 1. Executive Summary & Problem Formulation
- **Objective**: Adaptive neuro-fuzzy based hybrid classification model for emotion recognition from EEG signals.
