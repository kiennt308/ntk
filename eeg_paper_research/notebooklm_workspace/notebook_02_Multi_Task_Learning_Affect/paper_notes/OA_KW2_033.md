# Paper Note: OA_KW2_033

**Title:** Emotion recognition with multi-modal peripheral physiological signals  
**Authors:** Jennifer Gohumpu  
**Year:** 2023 | **Pages:** 9  
**PDF File:** `OA_KW2_033.pdf`  
**MD5 Hash:** `4791c0a1877d52f21234ba34d8b46792`  
**Cluster:** KW02 - Multi-Task Learning & Multi-Dimensional Affect

---

## 1. Executive Summary & Problem Formulation
- **Objective**: Emotion recognition with multi-modal peripheral physiological signals.
