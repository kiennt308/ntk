...
**Year:** 2023 | **Pages:** 28  
**PDF File:** `OA_KW2_035.pdf`  
**MD5 Hash:** `aa14529ab310e92ccedaac3b52d203e6`  
**Cluster:** KW02 - Multi-Task Learning & Multi-Dimensional Affect

---

## 1. Executive Summary & Problem Formulation
- **Objective**: Contrastive and Multi-Task Learning on Noisy Brain Signals with Nonlinear Dynamical Signatures.
