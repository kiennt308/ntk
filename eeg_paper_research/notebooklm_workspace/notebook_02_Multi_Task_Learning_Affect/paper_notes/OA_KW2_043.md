# Paper Note: OA_KW2_043

**Title:** Motor-imagery classiﬁcation model for brain-computer  
**Authors:** Affective Biosignals Research Consortium  
**Year:** 2023 | **Pages:** 26  
**PDF File:** `OA_KW2_043.pdf`  
**MD5 Hash:** `680aa1410e6fecb97a6eb7a073cc08ab`  
**Cluster:** KW02 - Multi-Task Learning & Multi-Dimensional Affect

---

## 1. Executive Summary & Problem Formulation
- **Objective**: Motor-imagery classiﬁcation model for brain-computer.
