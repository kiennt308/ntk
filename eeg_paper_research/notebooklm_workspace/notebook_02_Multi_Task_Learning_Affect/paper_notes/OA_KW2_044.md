# Paper Note: OA_KW2_044

**Title:** MIN2Net: End-to-End Multi-Task Learning for Subject-Independent  
**Authors:** Affective Biosignals Research Consortium  
**Year:** 2023 | **Pages:** 12  
**PDF File:** `OA_KW2_044.pdf`  
**MD5 Hash:** `a69eb5e8f7724ec55b54391ae3cb076a`  
**Cluster:** KW02 - Multi-Task Learning & Multi-Dimensional Affect

---

## 1. Executive Summary & Problem Formulation
- **Objective**: MIN2Net: End-to-End Multi-Task Learning for Subject-Independent.
