# Paper Note: OA_KW2_048

**Title:** Multi-task Learning with Weak Class Labels  
**Authors:** Affective Biosignals Research Consortium  
**Year:** 2023 | **Pages:** 18  
**PDF File:** `OA_KW2_048.pdf`  
**MD5 Hash:** `0e9e20444ce64587264a93e707aa1ce3`  
**Cluster:** KW02 - Multi-Task Learning & Multi-Dimensional Affect

---

## 1. Executive Summary & Problem Formulation
- **Objective**: Multi-task Learning with Weak Class Labels.
