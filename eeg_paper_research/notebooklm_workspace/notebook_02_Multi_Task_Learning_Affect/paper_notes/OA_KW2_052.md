...
**PDF File:** `OA_KW2_052.pdf`  
**MD5 Hash:** `ad5d2288233d70f7cc10917f0e09cc35`  
**Cluster:** KW02 - Multi-Task Learning in Affective Computing & Biosignals

---

## 1. Executive Summary & Problem Formulation
- **Research Objective**: Self-Supervised Graph Representation Learning for In-The-Wild Wearable and Smartphone based Emotion Recognition
