...
**Authors:** Rui Zhang  
**Year:** 2023 | **Pages:** 10  
**PDF File:** `OA_KW3_022.pdf`  
**MD5 Hash:** `653edbcb092653f5465474a3c2a4a9af`  
**Cluster:** KW03 - Multi-Branch & Cross-Modal Attention

---

## 1. Executive Summary & Problem Formulation
- **Objective**: Recognition of single upper limb motor imagery tasks from EEG using multi-branch fusion convolutional neural network.
