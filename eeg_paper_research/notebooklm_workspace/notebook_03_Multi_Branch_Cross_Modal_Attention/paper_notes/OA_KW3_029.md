# Paper Note: OA_KW3_029

**Title:** NEUROSPEX: NEURO-GUIDED SPEAKER EXTRACTION WITH CROSS-MODAL FUSION  
**Authors:** Affective Biosignals Research Consortium  
**Year:** 2023 | **Pages:** 8  
**PDF File:** `OA_KW3_029.pdf`  
**MD5 Hash:** `10fafd6150b03d3863c917e140966f83`  
**Cluster:** KW03 - Multi-Branch & Cross-Modal Attention

---

## 1. Executive Summary & Problem Formulation
- **Objective**: NEUROSPEX: NEURO-GUIDED SPEAKER EXTRACTION WITH CROSS-MODAL FUSION.
