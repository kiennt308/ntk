...
**Year:** 2023 | **Pages:** 10  
**PDF File:** `OA_KW3_034.pdf`  
**MD5 Hash:** `7b28af848ae67fbd0f7561dfe3d9ab7d`  
**Cluster:** KW03 - Multi-Branch & Cross-Modal Attention

---

## 1. Executive Summary & Problem Formulation
- **Objective**: A Joint Cross-Attention Model for Audio-Visual Fusion in Dimensional.
