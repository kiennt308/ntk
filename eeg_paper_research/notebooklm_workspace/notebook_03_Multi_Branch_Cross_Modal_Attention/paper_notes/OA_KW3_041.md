# Paper Note: OA_KW3_041

**Title:** Directional Spatial and Spectral Attention Network (DSSA Net) for EEG-based emotion recognition  
**Authors:** Jiyao Liu  
**Year:** 2023 | **Pages:** 15  
**PDF File:** `OA_KW3_041.pdf`  
**MD5 Hash:** `fe003172dca8116a6a1fa484abad31c5`  
**Cluster:** KW03 - Multi-Branch & Cross-Modal Attention

---

## 1. Executive Summary & Problem Formulation
- **Objective**: Directional Spatial and Spectral Attention Network (DSSA Net) for EEG-based emotion recognition.
