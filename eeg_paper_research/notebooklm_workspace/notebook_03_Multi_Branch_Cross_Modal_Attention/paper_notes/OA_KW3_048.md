# Paper Note: OA_KW3_048

**Title:** BiTCAN: An emotion recognition network based on saliency in brain cognition  
**Authors:** Yanling An1  
**Year:** 2023 | **Pages:** 26  
**PDF File:** `OA_KW3_048.pdf`  
**MD5 Hash:** `92b334e968e7bf591f0f25e2b7cd15bd`  
**Cluster:** KW03 - Multi-Branch & Cross-Modal Attention

---

## 1. Executive Summary & Problem Formulation
- **Objective**: BiTCAN: An emotion recognition network based on saliency in brain cognition.
