...
**DOI:** `10.48550/arXiv.2604.02397v1`  
**PDF File:** `OA_KW3_078.pdf`  
**MD5 Hash:** `b834c92b40787deac3540b04e06f8682`  
**Cluster:** KW03 - Multi-Branch & Cross-Modal Attention Architectures

---

## 1. Executive Summary & Problem Formulation
- **Research Objective**: Variational Encoder--Multi-Decoder (VE-MD) for Privacy-by-functional-design (Group) Emotion Recognition
