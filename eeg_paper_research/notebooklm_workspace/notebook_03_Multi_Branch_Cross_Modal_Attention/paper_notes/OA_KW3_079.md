...
**Authors:** Ying Liu; Yuntao Shou; Wei Ai; Tao Meng  
**Year:** 2026 | **Journal / Venue:** arXiv Preprints (Multi-Branch & Cross-Modal Attention)  
**DOI:** `10.1016/j.neucom.2026.133306`  
**PDF File:** `OA_KW3_079.pdf`  
**MD5 Hash:** `5f18edb705888d49abb8be3f9d195a92`  
**Cluster:** KW03 - Multi-Branch & Cross-Modal Attention Architectures

---

## 1. Executive Summary & Problem Formulation
- **Research Objective**: Relational graph-driven differential denoising and diffusion attention fusion for multimodal conversation emotion recognition
