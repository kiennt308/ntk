# Paper Note: OA_KW4_023

**Title:** Trusted emotion recognition based on multiple signals captured from video and its application in intelligent education  
**Authors:** Junjie Zhang, Cheng Fei, Yaqian Zheng et al.  
**Year:** 2024 | **Venue:** Electronic Research Archive  
**DOI:** [10.3934/era.2024161](https://doi.org/10.3934/era.2024161) | **Open Access PDF:** [http://www.aimspress.com/aimspress-data/era/2024/5/PDF/era-32-05-161.pdf](http://www.aimspress.com/aimspress-data/era/2024/5/PDF/era-32-05-161.pdf)  
**Cluster:** KW04 - Subspace Disentanglement & Domain Adaptation

---

## 1. Executive Summary & Problem Formulation
- **Objective**: Trusted emotion recognition based on multiple signals captured from video and its application in intelligent education.
