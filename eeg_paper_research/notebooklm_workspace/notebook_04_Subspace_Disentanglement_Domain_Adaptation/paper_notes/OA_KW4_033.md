# Paper Note: OA_KW4_033

**Title:** Multi-source domain adaptation for EEG emotion recognition based on inter-domain sample hybridization  
**Authors:** Xu Wu, Xiangyu Ju, Sheng Hui Dai et al.  
**Year:** 2024 | **Venue:** Frontiers in Human Neuroscience  
**DOI:** [10.3389/fnhum.2024.1464431](https://doi.org/10.3389/fnhum.2024.1464431) | **Open Access PDF:** [https://www.frontiersin.org/journals/human-neuroscience/articles/10.3389/fnhum.2024.1464431/pdf](https://www.frontiersin.org/journals/human-neuroscience/articles/10.3389/fnhum.2024.1464431/pdf)  
**Cluster:** KW04 - Subspace Disentanglement & Domain Adaptation

---

## 1. Executive Summary & Problem Formulation
- **Objective**: Multi-source domain adaptation for EEG emotion recognition based on inter-domain sample hybridization.
