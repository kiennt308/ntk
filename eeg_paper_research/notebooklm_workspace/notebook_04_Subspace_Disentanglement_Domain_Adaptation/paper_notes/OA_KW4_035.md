# Paper Note: OA_KW4_035

**Title:** MS-AGDA: A multi-source adaptive gating unsupervised domain adaptation for cross-subject and cross-session EEG-based emotion recognition  
**Authors:** Junqi Liu, Yuliang Ma, Michael J. Houston et al.  
**Year:** 2025 | **Venue:** Signal Image and Video Processing  
**DOI:** [10.1007/s11760-025-04819-9](https://doi.org/10.1007/s11760-025-04819-9) | **Open Access PDF:** [https://link.springer.com/content/pdf/10.1007/s11760-025-04819-9.pdf](https://link.springer.com/content/pdf/10.1007/s11760-025-04819-9.pdf)  
**Cluster:** KW04 - Subspace Disentanglement & Domain Adaptation

---

## 1. Executive Summary & Problem Formulation
- **Objective**: MS-AGDA: A multi-source adaptive gating unsupervised domain adaptation for cross-subject and cross-session EEG-based emotion recognition.
