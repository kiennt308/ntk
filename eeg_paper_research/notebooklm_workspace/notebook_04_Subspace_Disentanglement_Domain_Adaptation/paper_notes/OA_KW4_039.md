# Paper Note: OA_KW4_039

**Title:** Semi-Supervised Generative Adversarial Network for Stress Detection Using Partially Labeled Physiological Data  
**Authors:** Nibraas Khan, Sarkar, Nilanjan  
**Year:** 2022 | **Venue:** arXiv (Cornell University)  
**DOI:** [10.48550/arxiv.2206.14976](https://doi.org/10.48550/arxiv.2206.14976) | **Open Access PDF:** [https://arxiv.org/pdf/2206.14976.pdf](https://arxiv.org/pdf/2206.14976.pdf)  
**Cluster:** KW04 - Subspace Disentanglement & Domain Adaptation

---

## 1. Executive Summary & Problem Formulation
- **Objective**: Semi-Supervised Generative Adversarial Network for Stress Detection Using Partially Labeled Physiological Data.
