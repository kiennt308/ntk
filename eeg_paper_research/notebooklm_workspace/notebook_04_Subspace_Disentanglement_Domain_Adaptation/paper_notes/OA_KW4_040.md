# Paper Note: OA_KW4_040

**Title:** Self-Supervised Representation Learning: Introduction, advances, and challenges  
**Authors:** Linus Ericsson, Henry Gouk, Chen Change Loy et al.  
**Year:** 2022 | **Venue:** IEEE Signal Processing Magazine  
**DOI:** [10.1109/msp.2021.3134634](https://doi.org/10.1109/msp.2021.3134634) | **Open Access PDF:** [https://arxiv.org/pdf/2110.09327.pdf](https://arxiv.org/pdf/2110.09327.pdf)  
**Cluster:** KW04 - Subspace Disentanglement & Domain Adaptation

---

## 1. Executive Summary & Problem Formulation
- **Objective**: Self-Supervised Representation Learning: Introduction, advances, and challenges.
