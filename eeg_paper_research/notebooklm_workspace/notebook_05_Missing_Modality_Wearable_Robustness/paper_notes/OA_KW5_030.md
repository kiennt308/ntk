# Paper Note: OA_KW5_030

**Title:** Multimodal Brain–Computer Interface for In-Vehicle Driver Cognitive Load Measurement: Dataset and Baselines  
**Authors:** Prithila Angkan, Behnam Behinaein, Zunayed Mahmud et al.  
**Year:** 2024 | **Venue:** IEEE Transactions on Intelligent Transportation Systems  
**DOI:** [10.1109/tits.2023.3345846](https://doi.org/10.1109/tits.2023.3345846) | **Open Access PDF:** [https://arxiv.org/pdf/2304.04273.pdf](https://arxiv.org/pdf/2304.04273.pdf)  
**Cluster:** KW05 - Missing Modality & Wearable Robustness

---

## 1. Executive Summary & Problem Formulation
- **Objective**: Multimodal Brain–Computer Interface for In-Vehicle Driver Cognitive Load Measurement: Dataset and Baselines.
