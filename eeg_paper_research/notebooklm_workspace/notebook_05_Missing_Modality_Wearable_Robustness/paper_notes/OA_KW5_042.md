# Paper Note: OA_KW5_042

**Title:** LSM-2: Learning from Incomplete Wearable Sensor Data  
**Authors:** Maxwell A. Xu, Girish Narayanswamy, Kumar Ayush et al.  
**Year:** 2025 | **Venue:** arXiv (Cornell University)  
**DOI:** [10.48550/arxiv.2506.05321](https://doi.org/10.48550/arxiv.2506.05321) | **Open Access PDF:** [https://arxiv.org/pdf/2506.05321.pdf](https://arxiv.org/pdf/2506.05321.pdf)  
**Cluster:** KW05 - Missing Modality & Wearable Robustness

---

## 1. Executive Summary & Problem Formulation
- **Objective**: LSM-2: Learning from Incomplete Wearable Sensor Data.
