# Paper Note: OA_KW5_048

**Title:** Signal or Noise? Understanding Generative Models for Real-World Sensor Time Series  
**Authors:** Zitao Shuai, Zongzhe Xu, Yuntian Wu et al.  
**Year:** 2026 | **Venue:** arXiv (Cornell University)  
**DOI:** [](https://doi.org/) | **Open Access PDF:** [https://arxiv.org/pdf/2607.04245.pdf](https://arxiv.org/pdf/2607.04245.pdf)  
**Cluster:** KW05 - Missing Modality & Wearable Robustness

---

## 1. Executive Summary & Problem Formulation
- **Objective**: Signal or Noise? Understanding Generative Models for Real-World Sensor Time Series.
