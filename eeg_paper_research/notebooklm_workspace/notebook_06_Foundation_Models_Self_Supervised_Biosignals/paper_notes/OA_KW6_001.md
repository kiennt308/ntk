# Paper Note: OA_KW6_001

**Title:** EEG Based Emotion Recognition: A Tutorial and Review  
**Authors:** Xiang Li, Yazhou Zhang, Prayag Tiwari et al.  
**Year:** 2022 | **Venue:** ACM Computing Surveys  
**DOI:** [10.1145/3524499](https://doi.org/10.1145/3524499) | **Open Access PDF:** [https://arxiv.org/pdf/2203.11279.pdf](https://arxiv.org/pdf/2203.11279.pdf)  
**Cluster:** KW06 - Foundation Models & Self-Supervised Biosignals

---

## 1. Executive Summary & Problem Formulation
- **Objective**: EEG Based Emotion Recognition: A Tutorial and Review.
