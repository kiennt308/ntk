# Paper Note: OA_KW6_002

**Title:** Self-Supervised Contrastive Pre-Training For Time Series via Time-Frequency Consistency  
**Authors:** Xiang Zhang, Ziyuan Zhao, Theodoros Tsiligkaridis et al.  
**Year:** 2022 | **Venue:** arXiv (Cornell University)  
**DOI:** [10.48550/arxiv.2206.08496](https://doi.org/10.48550/arxiv.2206.08496) | **Open Access PDF:** [https://arxiv.org/pdf/2206.08496.pdf](https://arxiv.org/pdf/2206.08496.pdf)  
**Cluster:** KW06 - Foundation Models & Self-Supervised Biosignals

---

## 1. Executive Summary & Problem Formulation
- **Objective**: Self-Supervised Contrastive Pre-Training For Time Series via Time-Frequency Consistency.
