# Paper Note: OA_KW6_007

**Title:** Leveraging Generic Time Series Foundation Models for EEG Classification  
**Authors:** Théo Gnassounou, Yessin Moakher, Shifeng Xie et al.  
**Year:** 2025 | **Venue:** arXiv Preprint  
**DOI:** [10.48550/arXiv.2510.27522v1](https://doi.org/10.48550/arXiv.2510.27522v1) | **Open Access PDF:** [https://arxiv.org/pdf/2510.27522v1.pdf](https://arxiv.org/pdf/2510.27522v1.pdf)  
**Cluster:** KW06 - Foundation Models & Self-Supervised Biosignals

---

## 1. Executive Summary & Problem Formulation
- **Objective**: Leveraging Generic Time Series Foundation Models for EEG Classification.
