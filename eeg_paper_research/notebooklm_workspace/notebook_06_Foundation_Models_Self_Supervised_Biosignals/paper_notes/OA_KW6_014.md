# Paper Note: OA_KW6_014

**Title:** EEG-Bench: A Benchmark for EEG Foundation Models in Clinical Applications  
**Authors:** Ard Kastrati, Josua Bürki, Jonas Lauer et al.  
**Year:** 2025 | **Venue:** arXiv Preprint  
**DOI:** [10.48550/arXiv.2512.08959v1](https://doi.org/10.48550/arXiv.2512.08959v1) | **Open Access PDF:** [https://arxiv.org/pdf/2512.08959v1.pdf](https://arxiv.org/pdf/2512.08959v1.pdf)  
**Cluster:** KW06 - Foundation Models & Self-Supervised Biosignals

---

## 1. Executive Summary & Problem Formulation
- **Objective**: EEG-Bench: A Benchmark for EEG Foundation Models in Clinical Applications.
