# Paper Note: OA_KW6_030

**Title:** EEG-JEPA: Structured Latent Prediction for EEG Foundation Models  
**Authors:** Jinhao Li, Zhiyuan Ma, Xueqiao Han et al.  
**Year:** 2026 | **Venue:** arXiv Preprint  
**DOI:** [10.48550/arXiv.2608.00114v1](https://doi.org/10.48550/arXiv.2608.00114v1) | **Open Access PDF:** [https://arxiv.org/pdf/2608.00114v1.pdf](https://arxiv.org/pdf/2608.00114v1.pdf)  
**Cluster:** KW06 - Foundation Models & Self-Supervised Biosignals

---

## 1. Executive Summary & Problem Formulation
- **Objective**: EEG-JEPA: Structured Latent Prediction for EEG Foundation Models.
