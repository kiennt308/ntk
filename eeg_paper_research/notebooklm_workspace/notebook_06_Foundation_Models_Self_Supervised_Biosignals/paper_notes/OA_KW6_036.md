# Paper Note: OA_KW6_036

**Title:** Non-Contrastive Self-supervised Learning for Utterance-Level Information Extraction from Speech  
**Authors:** Jaejin Cho, Jes'us Villalba, Laureano Moro-Velazquez et al.  
**Year:** 2022 | **Venue:** arXiv Preprint  
**DOI:** [10.48550/arXiv.2208.05445v1](https://doi.org/10.48550/arXiv.2208.05445v1) | **Open Access PDF:** [https://arxiv.org/pdf/2208.05445v1.pdf](https://arxiv.org/pdf/2208.05445v1.pdf)  
**Cluster:** KW06 - Foundation Models & Self-Supervised Biosignals

---

## 1. Executive Summary & Problem Formulation
- **Objective**: Non-Contrastive Self-supervised Learning for Utterance-Level Information Extraction from Speech.
