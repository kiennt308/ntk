# Paper Note: OA_KW6_044

**Title:** Standing on the Shoulders of Giants: Rethinking EEG Foundation Model Pretraining via Multi-Teacher Distillation  
**Authors:** Chenqi Li, Yu Liu, Shuo Zhang et al.  
**Year:** 2026 | **Venue:** arXiv Preprint  
**DOI:** [10.48550/arXiv.2603.04478v1](https://doi.org/10.48550/arXiv.2603.04478v1) | **Open Access PDF:** [https://arxiv.org/pdf/2603.04478v1.pdf](https://arxiv.org/pdf/2603.04478v1.pdf)  
**Cluster:** KW06 - Foundation Models & Self-Supervised Biosignals

---

## 1. Executive Summary & Problem Formulation
- **Objective**: Standing on the Shoulders of Giants: Rethinking EEG Foundation Model Pretraining via Multi-Teacher Distillation.
