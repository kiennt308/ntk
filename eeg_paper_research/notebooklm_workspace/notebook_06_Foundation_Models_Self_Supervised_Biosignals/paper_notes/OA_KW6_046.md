...
**Authors:** Xiang Li, Jian Song, Zhigang Zhao et al.  
**Year:** 2024 | **Venue:** arXiv Preprint  
**DOI:** [10.48550/arXiv.2405.07260v1](https://doi.org/10.48550/arXiv.2405.07260v1) | **Open Access PDF:** [https://arxiv.org/pdf/2405.07260v1.pdf](https://arxiv.org/pdf/2405.07260v1.pdf)  
**Cluster:** KW06 - Foundation Models & Self-Supervised Biosignals

---

## 1. Executive Summary & Problem Formulation
- **Objective**: A Supervised Information Enhanced Multi-Granularity Contrastive Learning Framework for EEG Based Emotion Recognition.
