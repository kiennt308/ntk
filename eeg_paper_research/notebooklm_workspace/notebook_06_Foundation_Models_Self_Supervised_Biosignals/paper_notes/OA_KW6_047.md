# Paper Note: OA_KW6_047

**Title:** Image Segmentation in Foundation Model Era: A Survey  
**Authors:** Tianfei Zhou, Wang Xia, Fei Zhang et al.  
**Year:** 2024 | **Venue:** arXiv Preprint  
**DOI:** [10.48550/arXiv.2408.12957v3](https://doi.org/10.48550/arXiv.2408.12957v3) | **Open Access PDF:** [https://arxiv.org/pdf/2408.12957v3.pdf](https://arxiv.org/pdf/2408.12957v3.pdf)  
**Cluster:** KW06 - Foundation Models & Self-Supervised Biosignals

---

## 1. Executive Summary & Problem Formulation
- **Objective**: Image Segmentation in Foundation Model Era: A Survey.
