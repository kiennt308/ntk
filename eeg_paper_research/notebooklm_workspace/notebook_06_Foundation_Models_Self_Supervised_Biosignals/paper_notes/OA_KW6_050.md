# Paper Note: OA_KW6_050

**Title:** A Survey on Masked Autoencoder for Self-supervised Learning in Vision and Beyond  
**Authors:** Chaoning Zhang, Chenshuang Zhang, Junha Song et al.  
**Year:** 2022 | **Venue:** arXiv Preprint  
**DOI:** [10.48550/arXiv.2208.00173v1](https://doi.org/10.48550/arXiv.2208.00173v1) | **Open Access PDF:** [https://arxiv.org/pdf/2208.00173v1.pdf](https://arxiv.org/pdf/2208.00173v1.pdf)  
**Cluster:** KW06 - Foundation Models & Self-Supervised Biosignals

---

## 1. Executive Summary & Problem Formulation
- **Objective**: A Survey on Masked Autoencoder for Self-supervised Learning in Vision and Beyond.
