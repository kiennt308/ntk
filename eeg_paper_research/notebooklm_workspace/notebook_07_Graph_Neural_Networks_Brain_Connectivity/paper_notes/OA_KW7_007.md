# Paper Note: OA_KW7_007

**Title:** Proficient Graph Neural Network Design by Accumulating Knowledge on Large Language Models  
**Authors:** Jialiang Wang, Hanmo Liu, Shimin Di et al.  
**Year:** 2024 | **Venue:** arXiv Preprint  
**DOI:** [10.48550/arXiv.2408.06717v3](https://doi.org/10.48550/arXiv.2408.06717v3) | **Open Access PDF:** [https://arxiv.org/pdf/2408.06717v3.pdf](https://arxiv.org/pdf/2408.06717v3.pdf)  
**Cluster:** KW07 - Graph Neural Networks & Brain Connectivity

---

## 1. Executive Summary & Problem Formulation
- **Objective**: Proficient Graph Neural Network Design by Accumulating Knowledge on Large Language Models.
