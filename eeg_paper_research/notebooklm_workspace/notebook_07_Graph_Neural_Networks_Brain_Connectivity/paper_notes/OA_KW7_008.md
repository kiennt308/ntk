# Paper Note: OA_KW7_008

**Title:** Supplementary Materials to Graph Convolutional Branch and Bound  
**Authors:** Lorenzo Sciandra, Roberto Esposito, Andrea Cesare Grosso et al.  
**Year:** 2024 | **Venue:** arXiv Preprint  
**DOI:** [10.48550/arXiv.2406.03099v4](https://doi.org/10.48550/arXiv.2406.03099v4) | **Open Access PDF:** [https://arxiv.org/pdf/2406.03099v4.pdf](https://arxiv.org/pdf/2406.03099v4.pdf)  
**Cluster:** KW07 - Graph Neural Networks & Brain Connectivity

---

## 1. Executive Summary & Problem Formulation
- **Objective**: Supplementary Materials to Graph Convolutional Branch and Bound.
