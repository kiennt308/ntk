# Paper Note: OA_KW7_010

**Title:** Graph Neural Networks in EEG-based Emotion Recognition: A Survey  
**Authors:** Chenyu Liu, Yuqiu Deng, Yihao Wu et al.  
**Year:** 2024 | **Venue:** arXiv Preprint  
**DOI:** [10.48550/arXiv.2402.01138v6](https://doi.org/10.48550/arXiv.2402.01138v6) | **Open Access PDF:** [https://arxiv.org/pdf/2402.01138v6.pdf](https://arxiv.org/pdf/2402.01138v6.pdf)  
**Cluster:** KW07 - Graph Neural Networks & Brain Connectivity

---

## 1. Executive Summary & Problem Formulation
- **Objective**: Graph Neural Networks in EEG-based Emotion Recognition: A Survey.
