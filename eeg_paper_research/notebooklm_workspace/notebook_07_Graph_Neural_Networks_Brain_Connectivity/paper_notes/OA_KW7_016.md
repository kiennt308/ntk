...
**Authors:** Sergey Oladyshkin, Timothy Praditia, Ilja Kröker et al.  
**Year:** 2023 | **Venue:** arXiv Preprint  
**DOI:** [10.48550/arXiv.2306.14753v1](https://doi.org/10.48550/arXiv.2306.14753v1) | **Open Access PDF:** [https://arxiv.org/pdf/2306.14753v1.pdf](https://arxiv.org/pdf/2306.14753v1.pdf)  
**Cluster:** KW07 - Graph Neural Networks & Brain Connectivity

---

## 1. Executive Summary & Problem Formulation
- **Objective**: The Deep Arbitrary Polynomial Chaos Neural Network or how Deep Artificial Neural Networks could benefit from Data-Driven Homogeneous Chaos Theory.
