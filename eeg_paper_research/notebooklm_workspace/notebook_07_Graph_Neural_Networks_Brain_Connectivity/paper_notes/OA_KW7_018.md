# Paper Note: OA_KW7_018

**Title:** Adaptive Progressive Attention Graph Neural Network for EEG Emotion Recognition  
**Authors:** Tianzhi Feng, Chennan Wu, Yi Niu et al.  
**Year:** 2025 | **Venue:** arXiv Preprint  
**DOI:** [10.48550/arXiv.2501.14246v2](https://doi.org/10.48550/arXiv.2501.14246v2) | **Open Access PDF:** [https://arxiv.org/pdf/2501.14246v2.pdf](https://arxiv.org/pdf/2501.14246v2.pdf)  
**Cluster:** KW07 - Graph Neural Networks & Brain Connectivity

---

## 1. Executive Summary & Problem Formulation
- **Objective**: Adaptive Progressive Attention Graph Neural Network for EEG Emotion Recognition.
