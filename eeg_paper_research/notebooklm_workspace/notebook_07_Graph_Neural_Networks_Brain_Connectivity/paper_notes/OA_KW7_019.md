# Paper Note: OA_KW7_019

**Title:** MEEG and AT-DGNN: Improving EEG Emotion Recognition with Music Introducing and Graph-based Learning  
**Authors:** Minghao Xiao, Zhengxi Zhu, Kang Xie et al.  
**Year:** 2024 | **Venue:** arXiv Preprint  
**DOI:** [10.48550/arXiv.2407.05550v4](https://doi.org/10.48550/arXiv.2407.05550v4) | **Open Access PDF:** [https://arxiv.org/pdf/2407.05550v4.pdf](https://arxiv.org/pdf/2407.05550v4.pdf)  
**Cluster:** KW07 - Graph Neural Networks & Brain Connectivity

---

## 1. Executive Summary & Problem Formulation
- **Objective**: MEEG and AT-DGNN: Improving EEG Emotion Recognition with Music Introducing and Graph-based Learning.
