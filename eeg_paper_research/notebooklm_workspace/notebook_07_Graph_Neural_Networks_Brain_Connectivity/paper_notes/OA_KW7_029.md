# Paper Note: OA_KW7_029

**Title:** A Hybrid End-to-End Spatio-Temporal Attention Neural Network with Graph-Smooth Signals for EEG Emotion Recognition  
**Authors:** Shadi Sartipi, Mastaneh Torkamani-Azar, Mujdat Cetin  
**Year:** 2023 | **Venue:** arXiv Preprint  
**DOI:** [10.48550/arXiv.2307.03068v1](https://doi.org/10.48550/arXiv.2307.03068v1) | **Open Access PDF:** [https://arxiv.org/pdf/2307.03068v1](https://arxiv.org/pdf/2307.03068v1)  
**Cluster:** KW07 - Graph Neural Networks & Brain Connectivity

---

## 1. Executive Summary & Problem Formulation
- **Objective**: A Hybrid End-to-End Spatio-Temporal Attention Neural Network with Graph-Smooth Signals for EEG Emotion Recognition.
