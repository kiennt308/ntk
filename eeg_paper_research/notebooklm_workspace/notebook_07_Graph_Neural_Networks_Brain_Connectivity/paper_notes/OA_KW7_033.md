# Paper Note: OA_KW7_033

**Title:** ASTER: Adaptive Spatio-Temporal Early Decision Model for Dynamic Resource Allocation  
**Authors:** Shulun Chen, Wei Shao, Flora D. Salim et al.  
**Year:** 2025 | **Venue:** arXiv Preprint  
**DOI:** [10.48550/arXiv.2506.17929v1](https://doi.org/10.48550/arXiv.2506.17929v1) | **Open Access PDF:** [https://arxiv.org/pdf/2506.17929v1.pdf](https://arxiv.org/pdf/2506.17929v1.pdf)  
**Cluster:** KW07 - Graph Neural Networks & Brain Connectivity

---

## 1. Executive Summary & Problem Formulation
- **Objective**: ASTER: Adaptive Spatio-Temporal Early Decision Model for Dynamic Resource Allocation.
