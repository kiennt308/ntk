# Paper Note: OA_KW7_034

**Title:** V-STaR: Benchmarking Video-LLMs on Video Spatio-Temporal Reasoning  
**Authors:** Zixu Cheng, Jian Hu, Ziquan Liu et al.  
**Year:** 2025 | **Venue:** arXiv Preprint  
**DOI:** [10.48550/arXiv.2503.11495v1](https://doi.org/10.48550/arXiv.2503.11495v1) | **Open Access PDF:** [https://arxiv.org/pdf/2503.11495v1.pdf](https://arxiv.org/pdf/2503.11495v1.pdf)  
**Cluster:** KW07 - Graph Neural Networks & Brain Connectivity

---

## 1. Executive Summary & Problem Formulation
- **Objective**: V-STaR: Benchmarking Video-LLMs on Video Spatio-Temporal Reasoning.
