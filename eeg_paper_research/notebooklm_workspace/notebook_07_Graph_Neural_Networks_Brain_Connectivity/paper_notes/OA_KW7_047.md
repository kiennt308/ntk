# Paper Note: OA_KW7_047

**Title:** MSGM: A Multi-Scale Spatiotemporal Graph Mamba for EEG Emotion Recognition  
**Authors:** Hanwen Liu, Yifeng Gong, Zuwei Yan et al.  
**Year:** 2025 | **Venue:** arXiv Preprint  
**DOI:** [10.48550/arXiv.2507.15914v1](https://doi.org/10.48550/arXiv.2507.15914v1) | **Open Access PDF:** [https://arxiv.org/pdf/2507.15914v1.pdf](https://arxiv.org/pdf/2507.15914v1.pdf)  
**Cluster:** KW07 - Graph Neural Networks & Brain Connectivity

---

## 1. Executive Summary & Problem Formulation
- **Objective**: MSGM: A Multi-Scale Spatiotemporal Graph Mamba for EEG Emotion Recognition.
