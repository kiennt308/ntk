# Paper Note: OA_KW7_049

**Title:** A DenseNet-based method for decoding auditory spatial attention with EEG  
**Authors:** Xiran Xu, Bo Wang, Yujie Yan et al.  
**Year:** 2023 | **Venue:** arXiv Preprint  
**DOI:** [10.48550/arXiv.2309.07690v2](https://doi.org/10.48550/arXiv.2309.07690v2) | **Open Access PDF:** [https://arxiv.org/pdf/2309.07690v2.pdf](https://arxiv.org/pdf/2309.07690v2.pdf)  
**Cluster:** KW07 - Graph Neural Networks & Brain Connectivity

---

## 1. Executive Summary & Problem Formulation
- **Objective**: A DenseNet-based method for decoding auditory spatial attention with EEG.
