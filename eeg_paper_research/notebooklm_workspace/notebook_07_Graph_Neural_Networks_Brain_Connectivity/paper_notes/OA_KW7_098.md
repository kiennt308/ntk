# Paper Note: OA_KW7_098

**Title:** LERD: Latent Event-Relational Dynamics for Neurodegenerative Classification  
**Authors:** Yicheng Feng; Hairong Chen; Ziyu Jia; Samir Bhatt  
**Year:** 2026 | **Journal / Venue:** arXiv Preprints (Graph Neural Networks & Brain Connectivity)  
**DOI:** `10.48550/arXiv.2602.18195v2`  
**PDF File:** `OA_KW7_098.pdf`  
**MD5 Hash:** `c4be4e6b441b90100179593df500c811`  
**Cluster:** KW07 - Graph Neural Networks & Brain Connectivity

---

## 1. Executive Summary & Problem Formulation
- **Research Objective**: LERD: Latent Event-Relational Dynamics for Neurodegenerative Classification
