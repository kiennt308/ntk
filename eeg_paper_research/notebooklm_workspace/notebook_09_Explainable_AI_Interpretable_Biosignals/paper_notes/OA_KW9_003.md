# Paper Note: OA_KW9_003

**Title:** Machine learning with multimodal neuroimaging data to classify  
...
- **Objective**: Machine learning with multimodal neuroimaging data to classify.
