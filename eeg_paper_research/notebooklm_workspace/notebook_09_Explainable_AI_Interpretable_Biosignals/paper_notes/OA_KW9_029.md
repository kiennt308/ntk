# Paper Note: OA_KW9_029

**Title:** EMOVOME: A Dataset for Emotion Recognition in Spontaneous Real-Life Speech  
**Authors:** Lucía Gómez-Zaragozá, Rocío del Amor, María José Castro-Bleda et al.  
**Year:** 2024 | **Venue:** arXiv Preprint  
**DOI:** [10.48550/arXiv.2403.02167v3](https://doi.org/10.48550/arXiv.2403.02167v3) | **Open Access PDF:** [https://arxiv.org/pdf/2403.02167v3.pdf](https://arxiv.org/pdf/2403.02167v3.pdf)  
**Cluster:** KW09 - Explainable AI & Interpretable Biosignals

---

## 1. Executive Summary & Problem Formulation
- **Objective**: EMOVOME: A Dataset for Emotion Recognition in Spontaneous Real-Life Speech.
