...
**Year:** 2023 | **Pages:** 5  
**PDF File:** `OA_KW10_005.pdf`  
**MD5 Hash:** `d9fe9fd4e61ba12d223c046acfbdb3ab`  
**Cluster:** KW10 - Closed-Loop BCI & Real-Time Affective Systems

---

## 1. Executive Summary & Problem Formulation
- **Objective**: EmoShift: Lightweight Activation Steering for Enhanced Emotion-Aware Speech Synthesis.
