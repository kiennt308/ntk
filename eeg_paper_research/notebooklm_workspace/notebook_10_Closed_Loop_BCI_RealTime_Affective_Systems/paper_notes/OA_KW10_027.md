# Paper Note: OA_KW10_027

**Title:** Distilling EEG Representations via Capsules for  
**Authors:** Affective Computing & BCI Research Group  
**Year:** 2023 | **Pages:** 6  
**PDF File:** `OA_KW10_027.pdf`  
**MD5 Hash:** `f9eed13849650309c4c0cef69688dd84`  
**Cluster:** KW10 - Closed-Loop BCI & Real-Time Affective Systems

---

## 1. Executive Summary & Problem Formulation
- **Objective**: Distilling EEG Representations via Capsules for.
