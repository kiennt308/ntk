...
KEYWORDS = [
    ...
    },
    {
        ...
        "search_queries": [
            ...
            "self-supervised pre-training EEG brain decoding emotion"
        ]
    },
    {
        ...
        "search_queries": [
            ...
            "graph attention network EEG emotion classification"
        ]
    },
    {
        ...
        "search_queries": [
            ...
            "vision transformer EEG emotion spatial temporal attention"
        ]
    },
    {
        "id": "kw09_explainable_ai_interpretable_biosignals",
        "name": "Explainable AI (XAI) and Interpretable Biosignal Affective Models",
        "vietnamese_name": "Trí tuệ Nhân tạo Giải thích được (XAI) & Minh bạch Mô hình Cảm xúc",
        "target_count": 50,
        "search_queries": [
            "explainable AI EEG emotion recognition interpretable",
            "interpretability deep learning EEG affective biosignals",
            "SHAP Grad-CAM EEG emotion spatial frequency attribution",
            "feature attribution physiological emotion recognition XAI"
        ]
    },
    {
        "id": "kw10_closed_loop_bci_realtime_affective_systems",
        "name": "Closed-Loop BCI, Real-Time Edge Affective Systems and Mental Health",
        "vietnamese_name": "Hệ thống BCI Vòng lặp Khép kín, Tính toán Biên Thời gian thực",
        "target_count": 50,
        "search_queries": [
            "closed-loop BCI emotion recognition affective neuromodulation",
            "real-time EEG emotion recognition edge computing wearable",
            "wearable affective computing mental health monitoring biosignals",
            "embedded deep learning EEG emotion recognition real-time"
        ]
    }
]
...
def is_relevant(title, abstract):
    ...
    has_signal = any(k in text for k in ["eeg", "ecg", "eda", "gsr", "biosignal", "physiological", "brain", "cardiac", "electrodermal", "neuro", "wearable", "spatial-temporal", "bci"])
    has_affect = any(k in text for k in ["emotion", "affect", "valence", "arousal", "mood", "sentiment", "stress", "deap", "dreamer", "seed", "amigos", "cross-subject", "mental", "cognitive"])
...
def main():
    print("=================================================================")
    print("EXPANDING LITERATURE REPOSITORY TO 10 RESEARCH CLUSTERS")
    print("=================================================================")
    ...
    with open(master_readme, "w", encoding="utf-8") as f:
        f.write("# KHO TÀI LIỆU MỞ TOÀN DIỆN (COMPREHENSIVE OPEN ACCESS REPOSITORY - 10 CLUSTERS)\n")
        f.write("## ĐỀ TÀI TIẾN SĨ: KIẾN TRÚC HỌC ĐA NHIỆM VỤ ĐA NHÁNH CHO NHẬN DIỆN CẢM XÚC TỪ TÍN HIỆU Y SINH ĐA PHƯƠNG THỨC\n\n")
        f.write("Kho tài liệu mở rộng bao gồm **10 cụm từ khóa nghiên cứu chuyên sâu**, cung cấp nguồn tư liệu toàn văn hiện đại giai đoạn **2023–2026** phục vụ cho nghiên cứu sinh.\n\n")
    ...
    print("\n=================================================================")
    print(f"EXPANSION COMPLETE: {total_local}/{total_papers} PDFs locally stored across 10 keywords!")
